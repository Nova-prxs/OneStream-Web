...
Namespace OneStream.BusinessRule.Finance.XFW_FSK_ActifsIntercos
	Public Class MainClass
		'------------------------------------------------------------------------------------------------------------
		'Reference Code: 	XFW_FSK_ActifsIntercos
		'
		...
		Public Function Main(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As FinanceRulesApi, ByVal args As FinanceRulesArgs) As Object
			Try
				...
				Dim Memberlistname As String = "ActifsIntercos"
				Dim MemberListstart As String = "A#TOTACTIF.base"
