...
Namespace OneStream.BusinessRule.Finance.FCST_WCAP
...
#Region "DSO"
	...
	Sub WCAP_DSO (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		Dim sMesSiguiente As String = sMes + 1
		...
		Dim sPayablesCountry As String = String.Empty
		...
		For Each entityMember As MemberInfo In BRApi.Finance.Metadata.GetMembersUsingFilter(si, "Entities", "E#" & sParent & ".Base", True)
			...
			If i <> 0 Then
				...
				sPayablesCountry = sPayablesCountry & " + "

			End If
			
			sReceivablesCountry = sReceivablesCountry & "RemoveZeros(E#" & entityMember.Member.Name & ":A#Receivables_Acc:F#None:U1#Top:U2#Top:U3#Top:U4#Top:V#Periodic)" 'XX only U4#projections		
			sPayablesCountry = sPayablesCountry & "RemoveZeros(E#" & entityMember.Member.Name & ":A#Payables_Acc:F#None:U1#Top:U2#Top:U3#Top:U4#Top:V#Periodic)"		'XX only U4#projections
		...
		If Not api.Entity.HasChildren() Then
			If api.Cons.IsLocalCurrencyforEntity() Then
				If api.pov.Entity.name.endswith("001") And (ScenarioType = "Budget" Or (ScenarioType = "Forecast" And sMes > MesFcstNumber)) Then
					...
					api.Data.ClearCalculatedData("A#Payables_Country:U4#WCAP_DPO", True, True, True, True) 'Turnover_COUNTRY 
					...
					' Cuenta temporal para tener la agrupar los Revenues y de los COGS de las cajas del pais	
					 ...
					 api.Data.Calculate("A#Payables_Country:V#Periodic:F#None:U1#None:U2#None:U3#None:U4#WCAP_DPO = " & sPayablesCountry, True) 'Payables_COUNTRY
					...
					api.Data.Calculate("A#1541000CF:V#YTD:F#F14:U1#None:U2#None:U3#None:U4#WCAP_DSO:I#None = 
										...
										- A#02AC03:E#" & sParent & "001:V#Periodic:T#"& year &"M"& MesFcstNumber &":F#" & Flujo & ":U1#Top:U2#Top:U3#Top:U4#Top:I#None", True)
					...
					For Each sParentIC In parentDicc.Keys
						...
						api.Data.Calculate("E#"& sEntity &":A#Turnover_VAT:V#Periodic:F#None:U1#None:U2#None:U3#None:U4#WCAP_DSO:I#" & sParentIC & "001 = 
							...
							api.Data.Calculate("A#1541000CF:V#YTD:F#F14:U1#None:U2#None:U3#None:U4#WCAP_DSO:I#" & sParentIC & "001 = 
												...
												- A#02AC03:E#" & sParent & "001:V#Periodic:T#"& year &"M"& MesFcstNumber &":F#" & Flujo & ":U1#Top:U2#Top:U3#Top:U4#Top:I#" & sParentIC & "001", True)							
...
#Region "DPO"
	...
	Sub WCAP_DPO (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		'-----------------------------------------------------------------------------------
		' Introducción de DSO, DPO, DIO de Actuals en proposal
		'-----------------------------------------------------------------------------------
			...
			If api.Cons.IsLocalCurrencyforEntity() Then
				If api.pov.Entity.name.endswith("001") And (ScenarioType = "Budget" Or (ScenarioType = "Forecast" And sMes > MesFcstNumber)) Then
					...
					api.Data.Calculate("A#2721000CF:V#YTD:F#F14:U1#None:U2#None:U3#None:U4#WCAP_DPO:I#None = 
						...
						- A#05PC05:V#Periodic:T#"& year &"M"& MesFcstNumber &":F#" & Flujo & ":U1#Top:U2#Top:U3#Top:U4#Top:I#None", True)
					...
					api.Data.Calculate("A#1561021:V#Periodic:F#F20:U1#None:U2#None:U3#None:U4#WCAP_DPO:I#None = (-1)*A#COGS_Country:V#Periodic:F#None:U1#Top:U2#Top:U3#Top:U4#Top:I#Top * " & WVATPurchases & " * " & VAT & "", True)
					...
					api.Data.ClearCalculatedData("A#1681000CF:V#Periodic:F#F30:U1#None:U2#None:U3#None:U4#WCAP_DPO:I#None", True, True, True, True)
...
'''''					' Calculo de inventarios -1501000CF (no se tiene en cuenta el IVA)
'''''					api.Data.Calculate("A#1501000CF:V#YTD:F#F16:U1#None:U2#None:U3#None:U4#WCAP_DIO:I#None= 
'''''												((-1)*(A#COGS_Country:V#Periodic:F#Top:U1#Top:U2#Top:U3#Top:U4#WCAP_DPO:I#Top / 30 * " & DIOp & ") 
'''''												- A#02AC01:V#Periodic:F#" & Flujo & ":T#"& year &"M"& MesFcstNumber &":U1#Top:U2#Top:U3#Top:U4#Top:I#Top)", True)
										
'''''					api.Data.Calculate("A#1681000CF:V#YTD:F#F30:U1#None:U2#None:U3#None:U4#WCAP_DIO:I#None= 
'''''												(-1)*A#1501000CF:V#YTD:F#F16:U1#Top:U2#Top:U3#Top:U4#WCAP_DIO:I#Top", True)
