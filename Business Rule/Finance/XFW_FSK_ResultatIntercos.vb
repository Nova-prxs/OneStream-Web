...
Namespace OneStream.BusinessRule.Finance.XFW_FSK_ResultatIntercos
	Public Class MainClass
		'------------------------------------------------------------------------------------------------------------
		'Reference Code: 	XFW_FSK_ResultatIntercos
		'
		'Description:		To only list IC Accounts with data in Prior Period:ICEntities or Current Period:None 
		'
		...
		Public Function Main(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As FinanceRulesApi, ByVal args As FinanceRulesArgs) As Object
			Try
				...
				Dim Memberlistname As String = "ResultatIntercos"
				Dim MemberListstart As String = "A#Resultat.base"
                    ...
                    If Not objMemberInfos Is Nothing Then
                        ...
                        For Each objMemberInfo In objMemberInfos
                            If api.Account.IsIC(objMemberInfo.Member.MemberId) Then
								...
								Dim DataOUVD As DataCell = api.Data.GetDataCell("Cb#XFW_FSK:E#" & Entity & ":P#Groupe:C#Local:S#ACTUAL:T#WFPrior1:V#YTD:A#" & AccountName & ":F#None:O#Top:I#ICEntities:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None:U8#None")
								Dim DataCLOD As DataCell = api.Data.GetDataCell("Cb#XFW_FSK:E#" & Entity & ":P#Groupe:C#Local:S#ACTUAL:T#" & Period & ":V#YTD:A#" & AccountName & ":F#None:O#Top:I#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None:U8#None")
