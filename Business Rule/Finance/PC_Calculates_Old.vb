...
Namespace OneStream.BusinessRule.Finance.PC_Calculates_Old
		...
		Sub Recalculate_Costs(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As FinanceRulesApi, ByVal args As FinanceRulesArgs, ByVal sAccount As String, ByVal sCategory As String)
			...
			Or (sScenario = "Forecast" And iMonth >= iForecastMonth) Then
				...
				Dim sCalcAvg As String = $"S#{sScenario}:T#{sPeriod}:E#{sEntity}:A#{sAccount}:F#Amount_Initial_Result:O#Forms =	
									...
									( S#{sScenarioSource}:T#{sActualYear}M1:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M1:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M2:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M2:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M3:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M3:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M4:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M4:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M5:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M5:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M6:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M6:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M7:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M7:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top		
									+ S#{sScenarioSource}:T#{sActualYear}M8:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M8:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M9:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M9:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M10:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M10:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M11:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M11:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top
									+ S#{sScenarioSource}:T#{sActualYear}M12:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M12:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top)
...
'									S#{sScenarioSource}:T#{sActualYear}M1:E#{sEntity}:A#{sAccountActual}:F#None:O#Top * S#{sScenario}:T#{sActualYear}M1:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top"					
				...
				Else If Not dAmount_Variation = 0 Then 
					Dim customCellAmount As Decimal = Api.Data.GetDataCell($"A#{sAccount}:F#Amount_Initial_Result:O#Top").CellAmount
					If (customCellAmount = 0) Then
						sCalc2 = $"A#{sAccount}:F#None:O#Forms:I#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None:U8#None = {dAmount_Variation.ToString().Replace(",",".")}"	
					Else					
...
'				If Not isClosed Then Api.Data.Calculate(sCalcAccount,True)							
		...
		Sub Recalculate_Hours(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As FinanceRulesApi, ByVal args As FinanceRulesArgs, ByVal sAccount As String, ByVal sCategory As String)
			...
			Or (sScenario = "Forecast" And iMonth >= iForecastMonth) Then
				...
				' 1. INITIAL			
				Dim sCalcAvg As String = $"S#{sScenario}:T#{sPeriod}:E#{sEntity}:A#{sAccount}:F#Amount_Initial_Result:O#Forms:U2#{sCategory} =	
				
									( S#{sScenarioSource}:T#{sActualYear}M1:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M1:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M2:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M2:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M3:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M3:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M4:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M4:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M5:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M5:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M6:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M6:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M7:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M7:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}		
									+ S#{sScenarioSource}:T#{sActualYear}M8:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M8:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M9:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M9:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M10:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M10:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M11:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M11:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M12:E#{sEntity}:A#{sAccount}:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M12:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory})
									
									/ S#{sScenario}:T#{sActualYear}:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}) "											

				Dim sCalcAvgTotalHs As String = $"S#{sScenario}:T#{sPeriod}:E#{sEntity}:A#{sAccount}:F#Amount_Initial_Result:O#Forms:U2#{sCategory} =	
				
									( (S#{sScenarioSource}:T#{sActualYear}M1:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M1:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M1:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M2:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M2:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M2:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M3:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M3:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M3:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M4:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M4:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M4:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M5:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M5:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M5:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M6:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M6:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M6:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M7:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M7:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M7:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}		
									+ (S#{sScenarioSource}:T#{sActualYear}M8:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M8:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M8:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M9:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M9:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M9:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M10:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M10:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M10:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M11:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M11:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M11:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ (S#{sScenarioSource}:T#{sActualYear}M12:E#{sEntity}:A#productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory} + S#{sScenarioSource}:T#{sActualYear}M12:E#{sEntity}:A#non_productive_hs_total:F#PC_Import_Hours:O#Top:U2#{sCategory}) * S#{sScenario}:T#{sActualYear}M12:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory})
...
'				End If
			...
			Else							
				...
				Dim sCalcAccount As String = $"A#{sAccount}:F#None:U2#{sCategory} = A#{sAccountActual}:F#None:S#Actual:U2#{sCategory}"
			...
			Or (sScenario = "Forecast" And iMonth >= iForecastMonth) Then
				...
				Else
					...
					sCalcSameMonthAA = $"S#{sScenario}:T#{sPeriod}:E#{sEntity}:A#{sAccount}:F#Amount_Initial_Result:U1#None:O#Forms:U2#{sCategory} =	
									...
									, S#Actual:T#{sActualPrevYear}M{iMonth.toString}:E#{sEntity}:A#productive_hs_total:F#None:U1#Top:O#Top:U2#{sCategoryTop})"											
				...
				'BRApi.ErrorLog.LogMessage(si, "Calc1: " & sCalc1)		
'				If (sEntity = "SF172403" And sPeriod = "2025M10")
...
'				End If				
			    ...
			    ' Variation by brand + Percentage change by store + Absolute variation
				...
				ElseIf dPerc_Variation_Brand <> 0 And dPerc_Variation <> 0 Then
				    ' Variation by brand + Percentage variation by store
				...
				ElseIf dPerc_Variation_Brand <> 0 And dAmount_Variation <> 0 Then
				    ' Variation by brand + Absolute variation
				...
				ElseIf dPerc_Variation <> 0 And dAmount_Variation <> 0 Then
				    ' Percentage change by store + Absolute change
				...
				ElseIf dPerc_Variation <> 0 Then
				    'Percentage change by store only
				    sCalc2 = $"A#{sAccount}:F#None:O#Forms:U2#{sCategory} = A#{sAccount}:F#Amount_Initial_Result:O#Top:U2#{sCategory} * (1 + {(dPerc_Variation / 100).ToString().Replace(",", ".")})"
		...
		Sub Recalculate_HourCosts(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As FinanceRulesApi, ByVal args As FinanceRulesArgs, ByVal sAccount As String, ByVal sCategory As String)
			...
			Or (sScenario = "Forecast" And iMonth >= iForecastMonth) Then
				...
				Dim sCalcAvg As String = $"S#{sScenario}:T#{sPeriod}:E#{sEntity}:A#{sAccount}:F#Amount_Initial_Result:O#Forms:U2#{sCategory} =	
									...
									( S#{sScenarioSource}:T#{sActualYear}M1:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M1:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M2:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M2:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M3:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M3:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M4:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M4:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M5:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M5:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M6:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M6:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M7:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M7:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}		
									+ S#{sScenarioSource}:T#{sActualYear}M8:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M8:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M9:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M9:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M10:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M10:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M11:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M11:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M12:E#{sEntity}:A#{sCuentaSalario}:F#None:O#Top:U2#None * S#{sScenario}:T#{sActualYear}M12:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory})
									
									/ 
				
									( S#{sScenarioSource}:T#{sActualYear}M1:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M1:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M2:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M2:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M3:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M3:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M4:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M4:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M5:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M5:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M6:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M6:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M7:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M7:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}		
									+ S#{sScenarioSource}:T#{sActualYear}M8:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M8:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M9:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M9:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M10:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M10:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M11:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M11:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory}
									+ S#{sScenarioSource}:T#{sActualYear}M12:E#{sEntity}:A#hs_for_HourCosts:F#PC_Import_Hours:O#Top:U2#{sCategory} * S#{sScenario}:T#{sActualYear}M12:E#{sBrand}_Input:A#{sAccount}:F#Selected:O#Top:U2#{sCategory})"																																				
