...
Namespace OneStream.BusinessRule.Finance.PLAN_Calc_BeRo
...
''						Calc For the Price For the OP File, because there Is Not Price included
						...
						Formula = $"{Destination}=RemoveZeros({source})"
						api.Data.Calculate(Formula,Accountfilter:= "A#200000, A#201000, A#204000, A#205200, A#207200, A#203000, A#206000", isDurableCalculatedData:=True)  'BERO added cost account filter to not calculate unit cost for rev accounts
...
#Region "OP24 Transfer to final UD8s" 
						...
						If (api.Pov.Time.Name.Contains("2024") Or api.Pov.Time.Name.Contains("2022")) AndAlso api.Pov.Scenario.Name.Contains("Budget") 'Calculate prices upon loading the OP24. Other budgetv1 scenarios pull prices from Q_FCST
							...
							'Clear existing data 
							Api.Data.ClearCalculatedData(True,True,True,True,AccountFilter:="A#8.base", Ud8Filter:="U8#IFRS16_Plan, U8#Pre_IFRS16_Plan, U8#Price, U8#Volume, U8#Unit_Cost")
							...
							'Run seeding calculation
								...
								api.Data.Calculate("O#Import:F#None:U4#None:U5#None:U7#None:U8#Volume = RemoveZeros(O#Top:F#Top:U4#None:U5#Top:U7#Top:U8#Volume_Budgetv1_Load)", AccountFilter:="A#8.base, A#Non_Financial.Base",isDurableCalculatedData:=True)
...
'							UD8NameDestination = $"Pre_IFRS16_Plan"
						...
						FilterTwoStrings.Clear
						FilterTwoStrings.Add(New KeyValuePair(Of String, String)("Unit_Cost_Src", "A#200000, A#201000, A#204000, A#205200, A#207200, A#203000, A#206000"))
...
''						Calc For the Unit_Cost For the QFCST after seeding data from Actuals and Budgetv2
						...
						Formula = $"{Destination}=RemoveZeros({source})"
						api.Data.Calculate(Formula,Accountfilter:= "A#8_1_1_1_1_1_2.Base", isDurableCalculatedData:=True)  
...
#Region "Revenue Recalculation"
						...
						FilterTwoStrings.Clear
						FilterTwoStrings.Add(New KeyValuePair(Of String, String)("Price", "A#111000,A#122000,A#100000"))
						'BERO comment out 12.04.24 to only calculate revenue items
					
						'NON-COPAYMENT ACCOUNTS
...
'							api.Data.ClearCalculatedData(True, False, False, True, accountFilter:=accountFilter, originFilter:="O#Import",ud8Filter:="U8#Pre_IFRS16_Plan")
'							Source = "(-V#Periodic:U8#Price:O#Top:" & item.value &" * V#Periodic:U8#Volume:O#Top:" & item.value &" *  V#Periodic:U8#Copayment:O#Top:" & item.value &")"
'							Destination = "V#Periodic:U8#Pre_IFRS16_Plan:O#Import:" & item.key &""
'							Formula = $"{Destination}=removezeros({source})"
'							api.Data.Calculate(Formula, True)
...
#Region "BUD QFC: Move unit cost to the correct flow, ud5 and ud7"
					...
					FilterTwoStrings.Clear
					Dim CostAccounts As String = "A#200000, A#201000, A#204000, A#205200, A#207200, A#203000, A#206000"
...
#Region "BUD QFC: Cost Calculation" 
					'BERO 12.04.2024 Added UnitCost by Account * Total Revenue calculation for Cost of sales planning
						...
						Dim CostAccounts As String = "A#200000, A#201000, A#204000, A#205200, A#207200, A#203000, A#206000"
'						Dim SourceVOLUME As String = $"V#Periodic:U8#VOLUME:O#Top:A#8_1_1_1_1_1_1"
...
#Region "BUD QFC: Move manual input cost to the correct flow, ud5 and ud7"
					...
					FilterTwoStrings.Clear
					Dim CostAccounts As String = "A#203010, A#210000, A#210300, A#323000"
...
#Region "BUD QFC: Move manual input revenue to the correct flow, ud5 and ud7"
					...
					FilterTwoStrings.Clear
					Dim CostAccounts As String = "A#121000, A#108000, A#107000, A#106000, A#130000"
					FilterTwoStrings.Add(New KeyValuePair(Of String, String)("Pre_IFRS16_Plan",  CostAccounts))
...
#Region "BUD QFC: Move manual input Medical Salaries to the correct flow, ud5 and ud7"
					...
					FilterTwoStrings.Clear
					Dim MSAccounts As String = "A#8_1_1_1_1_2_1_1_1.Base,A#8_1_1_1_1_2_1_2_1.Base,A#8_1_1_1_1_2_1_3_1.Base"
...
#Region "BUD QFC: Move manual input SG&A to the correct flow, ud5 and ud7"
					...
					FilterTwoStrings.Clear
					Dim SGAAccounts As String = "A#8_1_1_1_1_3_1_1_1.Base, A#8_1_1_1_1_3_1_3_2_1.base, A#8_1_1_1_1_3_1_3_4.base, A#8_1_1_1_1_3_1_1_2.Base,A#306100,A#8_1_1_1_1_3_1_11.Base,A#8_1_1_1_1_3_1_2_4_1.Base,A#314600,A#311100,A#313200,A#314300,A#314400,A#314500,A#320000,A#311000,A#315000,A#8_1_1_1_1_3_1_2_4_2.Base,A#8_1_1_1_1_3_1_9_1.Base.Remove(Z33130),A#8_1_1_1_1_3_1_4.Base,A#8_1_1_1_1_3_1_6_1_1.Base,A#372000,A#372100,A#372400,A#372500,A#372600,A#8_1_1_1_1_3_1_5_1.Base,A#8_1_1_1_1_3_1_5_2.Base,A#8_1_1_1_1_3_1_5_3.Base,A#8_1_1_1_1_3_1_8_1.Base,A#8_1_1_1_1_3_1_10_1.Base.Remove(Z36130,123412),A#8_1_1_1_1_3_1_12_1.Base,A#321000"
...
#Region "BUD QFC: Move manual input BTL to the correct flow, ud5 and ud7"
					...
					FilterTwoStrings.Clear
					Dim BTLAccounts As String = "A#470700,A#470610,A#410000,A#410100,A#410200,A#411000,A#412000,A#452000,A#452100,A#470050,A#470090,A#470100,A#470200,A#470300,A#470400,A#470500,A#470550,A#470600,A#470650,A#471500,A#435000,A#440000,A#8_1_1_2_1_1_1_2_1.base,A#431100,A#430800,A#420000,A#8_1_2_1_1_3_1_2_1.Base"
...
#Region "BUD QFC: Move manual input DEPR to the correct flow, ud5 and ud7"
					...
					'to move manual inputs Of non-calculated BTL accounts Into their full dimensionality
					FilterTwoStrings.Clear
					Dim DEPRAccounts As String = "A#PPACV400,A#PPACV403"
...
#Region "IFRS16_Percentage_Capitalized"
						...
						If ScenarioMember.XFContainsIgnoreCase("Budget") Then
							InputMonth= $"{api.Time.GetYearFromId}M1"
...
'									End If	
						...
						For Each item As KeyValuePair(Of String, String) In FilterTwoStrings
							...
							Source = $"V#Periodic:O#Import:A#2_2_1_4:F#F_CLO:UD1#Top:UD2#Top:UD3#Top:UD4#Top:UD5#Top:UD6#Top:UD7#Top:UD8#{UD8NameSource}" 'Lease liabilities : Closing balance prior period
...
'						Purchases Operating Leases (capex)  : RoU
						...
						For Each item As KeyValuePair(Of String, String) In FilterTwoStrings
							...
							Source = $"V#Periodic:O#Import:A#Tech_Purchases:F#Top:UD1#Top:UD2#Top:UD3#Top:UD4#Top:UD5#Top:UD6#Top:UD7#{UD7NameSource}:UD8#{UD8NameSource}" 
...
'					FilterTwoStrings.Add(New KeyValuePair(Of String, String)("IFRS16_Plan", "A#PPACV400,A#PPACV403,A#311000,A#320000,A#430800"))
					...
					FilterTwoStrings.Add(New KeyValuePair(Of String, String)("SGA", "A#8_1_1_1_1_3_1_1_1.Base.Remove(304100,304300,304650,304700,304490,304491,304492,304493,304494,304495), A#8_1_1_1_1_3_1_1_2.Base,A#306100,A#8_1_1_1_1_3_1_11.Base,A#8_1_1_1_1_3_1_2_4_1.Base,A#314600,A#311100,A#313200,A#314300,A#314400,A#314500,A#315000,A#8_1_1_1_1_3_1_2_4_2.Base,A#8_1_1_1_1_3_1_9_1.Base.Remove(Z33130),A#8_1_1_1_1_3_1_4.Base,A#8_1_1_1_1_3_1_6_1_1.Base,A#372000,A#372100,A#372400,A#372500,A#372600,A#8_1_1_1_1_3_1_5_1.Base,A#8_1_1_1_1_3_1_5_2.Base,A#8_1_1_1_1_3_1_5_3.Base,A#8_1_1_1_1_3_1_8_1.Base,A#8_1_1_1_1_3_1_10_1.Base.Remove(Z36130,123412),A#8_1_1_1_1_3_1_12_1.Base,A#321000,A#8_1_1_1_1_3_1_3_2_1.base,A#8_1_1_1_1_3_1_3_4.Base"))
					FilterTwoStrings.Add(New KeyValuePair(Of String, String)("BTL", "A#470700,A#470610,A#410000,A#410100,A#410200,A#411000,A#412000,A#452000,A#452100,A#470050,A#470090,A#470100,A#470200,A#470300,A#470400,A#470500,A#470550,A#470600,A#470650,A#471500,A#435000,A#440000,A#PPACV400,A#PPACV403,A#8_1_1_2_1_1_1_2_1.Base,A#431100,A#420000,A#8_1_2_1_1_3_1_2_1.Base"))
...
#Region "Seed QFCST_X_Y to BudgetV1"
					...
					'Clear seeded data 
					Api.Data.ClearCalculatedData(True,True,True,True,AccountFilter:="A#8.base", Ud8Filter:="U8#Pre_ifrs16_plan_budgetv1_load, U8#Price_budgetv1_load, U8#Volume_budgetv1_load")
