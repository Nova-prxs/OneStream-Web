...
Namespace OneStream.BusinessRule.Finance.CONS_Allocation_Data
	...
	Public Class MainClass
		...
		Public Function Main(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As FinanceRulesApi, ByVal args As FinanceRulesArgs) As Object
			...
			Try
				...
				'Brapi.ErrorLog.LogMessage(si, "ItemID:" & sItemID)
...
#Region "Consultas"
		...
		Sub ClearAllocationRulesOne (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs, sTime As String, sScenario As String, sItemID As String)
			...
			sbSQL.Append(" FROM XFC_Allocation_Rules")																				
				...
				Select Case sScenarioType
					...
					Case "Forecast"
						...
						Select Case sScenario
							...
							Case "P11"
								'FAS_2023_11_23-SERIA P09, SE HA PUESTO P06, POR COPIA DE P09 EN P11 EN AÑO 2023
								sScenario_Driver = "P06"
								'FAS_2023_11_23-SERIA P09, SE HA PUESTO P06, POR COPIA DE P09 EN P11 EN AÑO 2023
						End Select
