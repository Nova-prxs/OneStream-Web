...
Namespace OneStream.BusinessRule.Finance.XFW_FSK_MemberFormulas
...
#Region "Member Formulas for Flows"
	...
	Sub FlowCarryForwardAPV (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		Dim DatoRealUlt = api.Data.GetDataCell("A#CR_Z:S#R:T#PovPriorYearM12:C#Local:O#Top:I#Top:V#YTD:F#Top:U1#top:U2#top:U3#top:U4#Gestion:U5#top:U6#top:U7#top:U8#None").CellAmount
		Dim DatoPrevUlt11 = api.Data.GetDataCell("A#CR_Z:S#P11:T#PovPriorYearM12:C#Local:O#Top:I#Top:V#YTD:F#Top:U1#top:U2#top:U3#top:U4#Gestion:U5#top:U6#top:U7#top:U8#None").CellAmount
		Dim DatoPrevUlt09 = api.Data.GetDataCell("A#CR_Z:S#P09:T#PovPriorYearM12:C#Local:O#Top:I#Top:V#YTD:F#Top:U1#top:U2#top:U3#top:U4#Gestion:U5#top:U6#top:U7#top:U8#None").CellAmount
		Dim DatoPrevUlt06 = api.Data.GetDataCell("A#CR_Z:S#P06:T#PovPriorYearM12:C#Local:O#Top:I#Top:V#YTD:F#Top:U1#top:U2#top:U3#top:U4#Gestion:U5#top:U6#top:U7#top:U8#None").CellAmount
		Dim DatoPrevUlt03 = api.Data.GetDataCell("A#CR_Z:S#P03:T#PovPriorYearM12:C#Local:O#Top:I#Top:V#YTD:F#Top:U1#top:U2#top:U3#top:U4#Gestion:U5#top:U6#top:U7#top:U8#None").CellAmount
...
'				api.Data.Calculate("F#" & Flow.Ouv.Name & " = F#" & Flow.Clo.Name & ":T#PovPriorYearM12")
			...
			' Calculamos APE CV y CF para Real (O;R;P;E)
				...
				Else If sScenarioType = "Forecast" Then
					...
					If periodNumber > 11 Then
						...
						If 	Not api.Entity.HasChildren() Then
							...
							'If DatoPrev3 <> 0 Then
								' Cartera de Ventas
								api.Data.ClearCalculatedData("F#APV:A#CV_Ventas:S#" & Scenario,True,True,True)
								api.Data.Calculate("F#APV:A#CV_Ventas:S#" & Scenario & " = F#SDC:A#CV_Ventas:T#PovPriorYearM12:S#R")	
									
								' Cartera de Facturación
								api.Data.ClearCalculatedData("F#APV:A#CV_Fact:S#" & Scenario,True,True,True)
								api.Data.Calculate("F#APV:A#CV_Fact:S#" & Scenario & "  = F#SDC:A#CV_Fact:T#PovPriorYearM12:S#R")
							'End If
						Else If api.Entity.HasChildren() Then
							api.Data.ClearCalculatedData("A#CV001:F#None:O#AdjInput:S#" & Scenario,True,True,True)
							api.Data.Calculate("A#CV001:F#None:O#AdjInput:S#" & Scenario & " = A#CV004:F#None:O#AdjInput:T#PovPriorYearM12:S#R")
							
							api.Data.ClearCalculatedData("A#CV006:F#None:O#AdjInput:S#" & Scenario,True,True,True)
							api.Data.Calculate("A#CV006:F#None:O#AdjInput:S#" & Scenario & "  = A#CV010:F#None:O#AdjInput:T#PovPriorYearM12:S#R")
						End If
				...
				Else If sScenarioType = "Budget" Then
...
'								Else 
								If DatoPrevUlt11 <> 0 Then
									If 	Not api.Entity.HasChildren() Then
										' Cartera de Ventas
										api.Data.ClearCalculatedData("F#APV:A#CV_Ventas:S#" & Scenario,True,True,True)
										api.Data.Calculate("F#APV:A#CV_Ventas:S#" & Scenario & " = F#SDC:A#CV_Ventas:T#PovPriorYearM12:S#P11")	
										
										' Cartera de Facturación
										api.Data.ClearCalculatedData("F#APV:A#CV_Fact:S#" & Scenario,True,True,True)
										api.Data.Calculate("F#APV:A#CV_Fact:S#" & Scenario & " = F#SDC:A#CV_Fact:T#PovPriorYearM12:S#P11")
									Else If api.Entity.HasChildren() Then
										api.Data.ClearCalculatedData("A#CV001:F#None:O#AdjInput:S#" & Scenario,True,True,True)
										api.Data.Calculate("A#CV001:F#None:O#AdjInput:S#" & Scenario & "  = A#CV004:F#None:O#AdjInput:T#PovPriorYearM12:S#P11")
										
										api.Data.ClearCalculatedData("A#CV006:F#None:O#AdjInput:S#" & Scenario,True,True,True)
										api.Data.Calculate("A#CV006:F#None:O#AdjInput:S#" & Scenario & "  = A#CV010:F#None:O#AdjInput:T#PovPriorYearM12:S#P11")
									End If
								...
								Else If DatoPrevUlt09 <> 0 Then
									If 	Not api.Entity.HasChildren() Then
										' Cartera de Ventas
										api.Data.ClearCalculatedData("F#APV:A#CV_Ventas:S#" & Scenario,True,True,True)
										api.Data.Calculate("F#APV:A#CV_Ventas:S#" & Scenario & " = F#SDC:A#CV_Ventas:T#PovPriorYearM12:S#P09")	
										
										' Cartera de Facturación
										api.Data.ClearCalculatedData("F#APV:A#CV_Fact:S#" & Scenario,True,True,True)
										api.Data.Calculate("F#APV:A#CV_Fact:S#" & Scenario & " = F#SDC:A#CV_Fact:T#PovPriorYearM12:S#P09")
									Else If api.Entity.HasChildren() Then
										api.Data.ClearCalculatedData("A#CV001:F#None:O#AdjInput:S#" & Scenario,True,True,True)
										api.Data.Calculate("A#CV001:F#None:O#AdjInput:S#" & Scenario & " = A#CV004:F#None:O#AdjInput:T#PovPriorYearM12:S#P09")
										
										api.Data.ClearCalculatedData("A#CV006:F#None:O#AdjInput:S#" & Scenario,True,True,True)
										api.Data.Calculate("A#CV006:F#None:O#AdjInput:S#" & Scenario & "  = A#CV010:F#None:O#AdjInput:T#PovPriorYearM12:S#P09")
									End If
								...
								Else If DatoPrevUlt06 <> 0 Then
									If 	Not api.Entity.HasChildren() Then
										' Cartera de Ventas
										api.Data.ClearCalculatedData("F#APV:A#CV_Ventas:S#" & Scenario,True,True,True)
										api.Data.Calculate("F#APV:A#CV_Ventas:S#" & Scenario & " = F#SDC:A#CV_Ventas:T#PovPriorYearM12:S#P06")	
										
										' Cartera de Facturación
										api.Data.ClearCalculatedData("F#APV:A#CV_Fact:S#" & Scenario,True,True,True)
										api.Data.Calculate("F#APV:A#CV_Fact:S#" & Scenario & "  = F#SDC:A#CV_Fact:T#PovPriorYearM12:S#P06")
									Else If api.Entity.HasChildren() Then
										api.Data.ClearCalculatedData("A#CV001:F#None:O#AdjInput:S#" & Scenario,True,True,True)
										api.Data.Calculate("A#CV001:F#None:O#AdjInput:S#" & Scenario & "  = A#CV004:F#None:O#AdjInput:T#PovPriorYearM12:S#P06")
										
										api.Data.ClearCalculatedData("A#CV006:F#None:O#AdjInput:S#" & Scenario,True,True,True)
										api.Data.Calculate("A#CV006:F#None:O#AdjInput:S#" & Scenario & "  = A#CV010:F#None:O#AdjInput:T#PovPriorYearM12:S#P06")
									End If
								...
								Else If DatoPrevUlt03 <> 0 Then
									If 	Not api.Entity.HasChildren() Then
										' Cartera de Ventas
										api.Data.ClearCalculatedData("F#APV:A#CV_Ventas:S#" & Scenario,True,True,True)
										api.Data.Calculate("F#APV:A#CV_Ventas:S#" & Scenario & " = F#SDC:A#CV_Ventas:T#PovPriorYearM12:S#P03")	
										
										' Cartera de Facturación
										api.Data.ClearCalculatedData("F#APV:A#CV_Fact:S#" & Scenario,True,True,True)
										api.Data.Calculate("F#APV:A#CV_Fact:S#" & Scenario & "  = F#SDC:A#CV_Fact:T#PovPriorYearM12:S#P03")
									Else If api.Entity.HasChildren() Then
										api.Data.ClearCalculatedData("A#CV001:F#None:O#AdjInput:S#" & Scenario,True,True,True)
										api.Data.Calculate("A#CV001:F#None:O#AdjInput:S#" & Scenario & "  = A#CV004:F#None:O#AdjInput:T#PovPriorYearM12:S#P03")
										
										api.Data.ClearCalculatedData("A#CV006:F#None:O#AdjInput:S#" & Scenario,True,True,True)
										api.Data.Calculate("A#CV006:F#None:O#AdjInput:S#" & Scenario & "  = A#CV010:F#None:O#AdjInput:T#PovPriorYearM12:S#P03")
									End If
								End If
							End If			
...
'				api.Data.Calculate("F#APV:A#CV_Fact = F#SDC:A#CV_Fact:T#PovPriorYearM12")
		...
		If (api.Cons.IsCurrency() And Not api.Cons.IsLocalCurrencyforEntity()) Then
			...
			Else If sScenarioType = "Forecast" Then
				...
				Dim rateTypeClo As FxRateType = api.FxRates.GetFxRateTypeForAssetLiability(0, 1048602) 'CubeId (CONSO), ScenarioId (Real)
...
''					api.data.calculate(String.Format(sExpression,"",""),,,"O#Top.Base.Remove(AdjInput)")
''					api.data.calculate(String.Format(sExpression, ":O#AdjConsolidated",":O#AdjInput"))
					api.Data.Calculate("A#" & Acct.ResEx.Name & ":F#" & Flow.Aff.Name & "=-A#" & Acct.ResEx.Name & ":F#" & Flow.Ouv.Name & "-A#" & Acct.ResEx.Name & ":F#APM")					
					api.Data.Calculate("A#" & Acct.ResC.Name & ":F#" & Flow.Aff.Name & "=-A#" & Acct.ResC.Name & ":F#" & Flow.Ouv.Name & "-A#" & Acct.ResC.Name & ":F#APM")					
'				
'				Else
'					Dim sExpression As String = "F#" & Flow.Aff.Name & "{0}=F#" & Flow.Aff.Name & ":C#Local{1} * " & FX.averageRatePriorYEtoText
'					api.data.calculate(String.Format(sExpression,"",""),,,"O#Top.Base.Remove(AdjInput)")
	...
	If Cube = "CONSO" Then
		...
		If Year > 2019 Then
			...
			If (api.Cons.IsCurrency() And Not api.Cons.IsLocalCurrencyforEntity()) Then
				...
				If Not(sScenarioType = "Budget") Then
		...
		'fs			Dim sExpression As String = "F#" & Flow.ECO.Name & "{0}=" & OUV_TC_TCO & "+" & ENT_TC_TCO  & "+" & SOR_TC_TCO  & "+" & FUS_TC_TCO & "+" & FTA_TC_TCO & "+" & AFF_TC_TCO
				...
				ElseIf sScenarioType = "Budget" Then
					'Dimensiones para calcular el escenario Objetivo
					Dim DatoRealUlt = api.Data.GetDataCell("A#CR_Z:S#R:T#PovPriorYearM12:C#Local:O#Top:I#Top:V#YTD:F#Top:U1#top:U2#top:U3#top:U4#Gestion:U5#top:U6#top:U7#top:U8#None").CellAmount
					Dim DatoPrevUlt11 = api.Data.GetDataCell("A#CR_Z:S#P11:T#PovPriorYearM12:C#Local:O#Top:I#Top:V#YTD:F#Top:U1#top:U2#top:U3#top:U4#Gestion:U5#top:U6#top:U7#top:U8#None").CellAmount
					Dim DatoPrevUlt09 = api.Data.GetDataCell("A#CR_Z:S#P09:T#PovPriorYearM12:C#Local:O#Top:I#Top:V#YTD:F#Top:U1#top:U2#top:U3#top:U4#Gestion:U5#top:U6#top:U7#top:U8#None").CellAmount
...
'					Else
	...
	Else
		If (api.Cons.IsCurrency() And Not api.Cons.IsLocalCurrencyforEntity()) Then
			...
			'20222312 En O y P no estaba convirtiendo bien cuando habia APC, esta duplicando DCA
			Else ' otro escenario distinto de real
				...
				Dim AFF_TC_TCO As String = "(F#" & flow.Aff.Name & ":C#Local{1} * " & FX.averageRateToText & "-F#" & flow.Aff.Name & ":C#Local{1} * " & FX.averageRatePriorYEtoText & ")"
				'Dim APC_TC_TCO As String = "(F#APC:C#Local{1} * " & FX.closingRateToText & "-F#APC:C#Local{1} * " & closingRatePriorRealToText & ")"					
				Dim APC_TC_TCO As String = "(F#APC:C#Local{1} * " & FX.closingRateToText & "-F#APC{0})"
				Dim APV_TC_TCO As String = "(F#APV:C#Local{1} * " & FX.closingRateToText & "-F#APV:C#Local{1} * " & closingRatePriorRealToText & ")"
		...
		ElseIf CurYear > 2019 Then
			If Not api.Entity.HasChildren() Then
				...
				ElseIf (api.Pov.Cons.Name ="OwnerPreAdj") Or (api.Pov.Cons.Name ="OwnerPostAdj") Then
					...
					api.Data.ClearCalculatedData("A#CV_Ventas:O#AdjInput:F#INC",True,True,True)
					api.Data.Calculate("A#CV_Ventas:O#AdjInput:F#INC=A#CV002:O#AdjInput:F#None")
					'20230424 por asiento en CV003 que CV_Ventas no estaba reconociendo
					api.Data.ClearCalculatedData("A#CV_Ventas:O#AdjInput:F#DIS",True,True,True)
					api.Data.Calculate("A#CV_Ventas:O#AdjInput:F#DIS=A#CV003:O#AdjInput:F#None*(-1)")
	...
	Dim CurYear As Integer = api.Time.GetYearFromId(timeId)
		...
		If Not api.Entity.HasChildren() Then
			...
			Else If (api.Pov.Cons.Name ="OwnerPreAdj" Or api.Pov.Cons.Name ="OwnerPostAdj") Then
				...
				'20230424 modificado para que CV004 calcule SDC con asientos imputados
				api.Data.Calculate("A#CV004:F#None=A#CV001:F#None + A#CV002:F#None - A#CV003:F#None + A#CV005:F#None + A#CV_A_FCT:F#None")
	...
	Dim CurYear As Integer = api.Time.GetYearFromId(timeId)
		...
		If Not api.Entity.HasChildren() Then
			...
			Else If (api.Pov.Cons.Name ="OwnerPreAdj" Or api.Pov.Cons.Name ="OwnerPostAdj") Then
				...
				api.Data.Calculate("A#CV010:F#None=A#CV006:F#None + A#CV007:F#None - A#CV008:F#None + A#CV009:F#None + A#CV_B_FCT:F#None")
...
#Region "Member Formulas for BS Accounts"
	...
	Sub AcctResEx (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		Dim Flow As Object = Me.InitFlowClass(si, api, globals)
		Dim Acct As Object = Me.InitAccountClass(si, api, globals)
		Dim sCube As String = api.Pov.Cube.Name
		...
		If Not api.Entity.HasChildren() Then
			If api.Cons.IsLocalCurrencyforEntity() Then
				...
				api.Data.Calculate("A#" & Acct.ResEx.Name & ":F#" & Flow.Aff.Name & "=-A#" & Acct.ResEx.Name & ":F#" & Flow.Ouv.Name & " -A#" & Acct.ResEx.Name & ":F#APM")
				'VIT api.Data.Calculate("A#" & Acct.ResEx.Name & ":F#" & Flow.Aff.Name & "=-A#" & Acct.ResEx.Name & ":F#APM")
				api.Data.Calculate("A#" & Acct.ResEx.Name & ":O#AdjInput:F#" & Flow.Aff.Name & "=-A#" & Acct.ResEx.Name & ":O#AdjInput:F#APM")

				api.Data.Calculate("A#" & Acct.ResEx.Name & ":O#Forms:F#" & Flow.Res.Name & ":I#None:U3#None:U4#None:U5#None:U6#None:U7#None:U8#None=A#" & Acct.TopIS.Name & ":O#Forms:F#None:I#Top:U3#Top:U4#Legal:U5#None:U6#None:U7#Top:U8#None")
				api.Data.Calculate("A#" & Acct.ResEx.Name & ":O#Forms:F#" & Flow.Clo.Name & "=A#" & Acct.ResEx.Name & ":O#Forms:F#" & Flow.Res.Name & "")
				api.Data.Calculate("A#" & Acct.ResEx.Name & ":O#Import:F#" & Flow.Res.Name & ":I#None:U3#None:U4#None:U5#None:U6#None:U7#None:U8#None=A#" & Acct.TopIS.Name & ":O#Import:F#None:I#Top:U3#Top:U4#Legal:U5#None:U6#None:U7#Top:U8#None")
		...
		If sCube = "FISCAL" Then
			'Declare adjustment intersection
			Dim reservesAdjIntersection As String = "Cb#FISCAL:S#F:A#113999:V#YTD:F#SDC:O#Import:I#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None:U8#None"
			
			'Clear and calculate Import
			api.Data.ClearCalculatedData(reservesAdjIntersection,True,True,True,True)
			api.Data.Calculate($"
				{reservesAdjIntersection} = 
				Cb#CONSO:S#R:T#POVPrior2:A#129000:V#YTD:F#Top:O#Top:I#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:U8#None
				- Cb#FISCAL:S#F:A#129000:V#YTD:F#Top:O#Top:I#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:U8#None
				)",
				True
			)
		End If
	...
	Sub AcctRsvC (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		If Not api.Entity.HasChildren() And (api.Cons.IsCurrency() And Not api.Cons.IsLocalCurrencyforEntity()) Then
			...
			Dim sExpression As String = "A#" & Acct.RsvC.name & ":F#" & Flow.ECO.name & "{0}=" & CPOUV_TC_TCO & "+" & CPAFF_TC_TM1'  & "+" & CPAFF_TM_TM1   & "-" & CPAFF_TMC_TM1
			api.data.calculate(String.Format(sExpression,"",""),,,"O#Top.Base.Remove(AdjInput)")
			api.data.calculate(String.Format(sExpression, ":O#AdjConsolidated",":O#AdjInput"))
			...
			sExpression = "A#" & Acct.RsvC.name & ":F#" & Flow.ECF.name & "{0}=" & CPCLO_TC_TM & "+" & CPOUV_TM_TC & "+" & CPAFF_TM_TC & "-" & CPDIV_TM_TM1 & "+" & CPFPE_FPL_TC & "+" & CPAFF_TMC_TM1 '& "+" & CPAFF_TM_TC1
			api.data.calculate(String.Format(sExpression,"",""),,,"O#Top.Base.Remove(AdjInput)")
			api.data.calculate(String.Format(sExpression, ":O#AdjConsolidated",":O#AdjInput"))
...
'fs disabled above section, as in Ingeteam Investment in subs must be translated like any other BS acct
	...
	Sub SUPERAVIT (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		If (Not api.Entity.HasChildren() And (api.Cons.IsLocalCurrencyforEntity())) Then
			...
			api.Data.Calculate("A#SUPERAVIT:O#Import:F#MOV:I#None:U1#None:U2#None:U3#None:U5#None:U6#None:U7#None:U8#None = -A#BSA:O#Import:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None + A#BSP:O#Import:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None")
			api.Data.Calculate("A#SUPERAVIT:O#Import:F#SDC:I#None:U1#None:U2#None:U3#None:U5#None:U6#None:U7#None:U8#None = A#SUPERAVIT:O#Import:F#MOV:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None")
			api.Data.Calculate("A#SUPERAVIT:O#Forms:F#MOV:I#None:U1#None:U2#None:U3#None:U5#None:U6#None:U7#None:U8#None = -A#BSA:O#Forms:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None + A#BSP:O#Forms:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None")
			api.Data.Calculate("A#SUPERAVIT:O#Forms:F#SDC:I#None:U1#None:U2#None:U3#None:U5#None:U6#None:U7#None:U8#None = A#SUPERAVIT:O#Forms:F#MOV:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None")
	...
	Sub AcctADJS (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		If (Not api.Entity.HasChildren() And (api.Cons.IsLocalCurrencyforEntity() Or (api.Pov.Cons.Name = "OwnerPostAdj") Or (api.Pov.Cons.Name = "OwnerPreAdj") Or api.cons.IsForeignCurrencyForEntity)) Then
			...
			api.Data.ClearCalculatedData("A#ADJS:O#AdjInput:F#REC:I#None:U1#None:U2#None:U3#None:U5#None:U6#None:U7#None:U8#None",True,True,True,True)
			api.Data.ClearCalculatedData("A#ADJS:O#AdjInput:F#SDC:I#None:U1#None:U2#None:U3#None:U5#None:U6#None:U7#None:U8#None",True,True,True,True)
			
			api.Data.Calculate("A#ADJS:O#AdjInput:F#REC:I#None:U1#None:U2#None:U3#None:U5#None:U6#None:U7#None:U8#None = -A#BSA:O#AdjInput:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None + A#BSP:O#AdjInput:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None")
			api.Data.Calculate("A#ADJS:O#AdjInput:F#SDC:I#None:U1#None:U2#None:U3#None:U5#None:U6#None:U7#None:U8#None = A#ADJS:O#AdjInput:F#REC:I#Top:U1#Top:U2#Top:U3#Top:U5#None:U6#None:U7#Top:U8#None")
...
End Sub
	...
	api.Data.Calculate("A#TAM_CD001:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
	A#CD001:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	api.Data.Calculate("A#TAM_CD002:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
	A#CD002:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CD003 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CD003:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CD003:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CD004 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CD004:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CD004:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CV008 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CV008:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CV008:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CTRL_477 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_477:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CTRL_477:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CTRL_472 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_472:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CTRL_472:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSP_C_V_1 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSP_C_V_1:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSP_C_V_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSP_C_V_2 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSP_C_V_2:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSP_C_V_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSP_C_V_3 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSP_C_V_3:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSP_C_V_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSA_B_II_1 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSA_B_II_1:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSA_B_II_1:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSA_B_II_2 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSA_B_II_2:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSA_B_II_2:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSA_B_II_3 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSA_B_II_3:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSA_B_II_3:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSA_B_II_4 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSA_B_II_4:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSA_B_II_4:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSA_B_II_5 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSA_B_II_5:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSA_B_II_5:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_BSA_B_II_6 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_BSA_B_II_6:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#BSA_B_II_6:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")

	End Sub
'--FELI 2023-01-17
Sub CalcTAM_CR_A (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		api.Data.ClearCalculatedData("A#TAM_CR_A",True,True,True)
		
		api.Data.Calculate("A#TAM_CR_A:I#None:F#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_A:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
...
'FELI 2023-01-17 --
	Sub CalcTAM_CR_B (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CR_B:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_B:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
...
'--FELI 2023-05-05
	Sub CalcTAM_CR_D2 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CR_D2:I#None:F#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_D2:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CR_D3 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CR_D3:I#None:F#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_D3:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")

	End Sub
	
	Sub CalcTAM_CR_D9 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		api.Data.ClearCalculatedData("A#TAM_CR_D9",True,True,True)
		
		api.Data.Calculate("A#TAM_CR_D9:I#None:F#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_D9:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CR_E (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CR_E:I#None:F#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_E:I#Top:F#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
...
'FELI 2023-05-05 --
	Sub CalcTAM_CR_G (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CR_G:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_G:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CR_Q11 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CR_Q11:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_Q11:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CR_Q22 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CR_Q22:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_Q22:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CR_Q23 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CR_Q23:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CR_Q23:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CG (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CG:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CG:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CG_13 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CG_13:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CG_13:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_CG_14 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_CG_14:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#CG_14:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")

	End Sub
'FELI 2023-04-14
	Sub CalcTAM_400900 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		api.Data.ClearCalculatedData("A#TAM_400900",True,True,True)
		
		api.Data.Calculate("A#TAM_400900:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#400900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	End Sub
	Sub CalcTAM_403900 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		api.Data.ClearCalculatedData("A#TAM_403900",True,True,True)
		
		api.Data.Calculate("A#TAM_403900:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#403900:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Legal:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	End Sub
		'FELI 2023-04-14	
	Sub CalcTAM_640200 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_640200:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#640200:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
	...
	Sub CalcTAM_6692 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		api.Data.Calculate("A#TAM_6692:I#None:F#None:U1#None:U2#None:U3#None:U4#None:U5#None:U6#None:U7#None = 
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POV:V#Periodic + 
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior1:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior2:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior3:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior4:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior5:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior6:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior7:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior8:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior9:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior10:V#Periodic +
		A#6692:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:T#POVPrior11:V#Periodic")
...
Sub Calc_SSGG (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)		
	...
	If (Not api.Entity.HasChildren() And api.Cons.IsLocalCurrencyforEntity()) Then			
		...
		'A partir de 2023 se desactiva la regla de SSGG y se comienzan a utilizar las reglas de repartos
		If CurYear <= 2022 Then
			
			If api.Pov.Scenario.Name = "R" Then	
				If CurYear > 2020 And CurYear < 2022 Then
				...
				Else 'If CurYear = 2022 Then
					...
					Else 'En diciembre la 623200 tiene que repartir entera en CR_W2, independientemente del ICP
						If (periodNumber = "1" Or periodNumber = "2" Or periodNumber = "3" Or periodNumber = "4" Or periodNumber = "5") Then
							ScenarioBase = "O1"
							Account_INV = "Pres_Aprob_Año_N"
						Else If (periodNumber = "6" Or periodNumber = "7" Or periodNumber = "8" Or periodNumber = "9" Or periodNumber = "10" Or periodNumber = "11") Then
						...
						Else
							...
							Account_INV = "Prev_Inv"
						End If
						Me.SSGG_Reparto_NEW(si, api, globals, args, ScenarioBase, Account_INV)
					End If
				End If
			...
			Me.R_CDR_Calc_ABDE(si, api, globals, args)
			Me.R_CDR_Calc_GHJWLM(si, api, globals, args)
			Me.R_CDR_Calc_NOQ(si, api, globals, args)
			Me.R_CDR_Calc_SUWY(si, api, globals, args)				
...
Sub SSGG_Reparto_NEW (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs, ScenarioBase As String, Account_INV As String)
	...
	If DatoHolding > 0 Then
		...
		For Each UD1M As member In ListaUd1 
			If api.Data.GetDataCell("A#Total_Repartir:F#None:O#Forms:I#None:U1#" & UD1M.Name.ToString & ":U2#HD01").CellAmount <> 0 Then
				...
				'NEW Neteo
				api.Data.Calculate("A#CR_W2J9:F#None:I#" & POVEntity & ":U1#9909:U2#9909:U4#Repartir_SSGG = A#CR_V:F#Top:I#Top:U1#HD01:U2#Top:U4#Gestion")
							
				'NEW Ingreso CR_W1
				api.Data.Calculate("A#CR_W1:F#None:I#" & POVEntity & ":U1#HD01:U2#" & UD1M.Name.ToString & ":U3#All:U4#Repartir_SSGG:U5#All = A#CR_W1:F#None:I#" & POVEntity & ":U1#HD01:U2#" & UD1M.Name.ToString & ":U3#All:U4#Repartir_SSGG:U5#All + A#CR_W2J9:F#None:I#" & POVEntity & ":U1#" & UD1M.Name.ToString & ":U2#HD01:U3#All:U4#Repartir_SSGG:U5#All")
						
				'Reparto 623200
				api.Data.Calculate("A#623200:F#None:I#" & POVEntity & ":U1#" & UD1M.Name.ToString & ":U2#HD01:U3#All:U4#Repartir_SSGG:U5#All = A#623200:F#Top:I#Top:U1#HD01:U2#Top:U3#All:U4#Gestion:U5#All * " & PesoFinal & "")
								
				'NEW Neteo
				api.Data.Calculate("A#623200:F#None:I#" & POVEntity & ":U1#9909:U2#9909:U4#Repartir_SSGG = -A#623200:F#Top:I#Top:U1#HD01:U2#Top:U4#Gestion")
				...
				'Vaciado de CR_W1
				api.Data.Calculate("A#CR_W1:F#None:I#" & POVEntity & ":U1#9909:U2#9909:U4#Repartir_SSGG = A#CR_V:F#None:I#Top:U1#HD01:U2#Top:U4#Gestion - A#623200:F#None:I#Top:U1#HD01:U2#Top:U4#Gestion")
			End If	
		Next
	End If
End Sub
...
'			2023 - Cambio por tipología de escenario
			If (sScenarioType = "Budget" _
			Or sScenarioType = "Forecast" ) Then
			
			'If (api.Pov.Scenario.Name = "O1" 
			'Or api.Pov.Scenario.Name = "O2" 
			'Or api.Pov.Scenario.Name = "O3" 
			'Or api.Pov.Scenario.Name = "P03" 
			'Or api.Pov.Scenario.Name = "P06" 
			'Or api.Pov.Scenario.Name = "P09" 
...
'				BRApi.ErrorLog.LogMessage(si,"Entity " & api.Pov.Entity.Name & " - Pov Time:" & api.Pov.Time.Name)
'				BRApi.ErrorLog.LogMessage(si,"Entity " & api.Pov.Entity.Name & " - Mes12:" & CurYear.ToString() & "M12")
				
				If Not api.Pov.Time.Name = CurYear.ToString() & "M12" Then		
																																								
					'CDR					
					api.Data.Calculate(" UD4#Repartir_Mensualizacion =  UD4#Gestion:T#" & ObjetivoM12 & "/12 * " & periodMultiplier & "", "A#CDR.Base",, "O#AdjInput",,,,,,,,,,,, True)
					api.Data.Calculate(" UD4#Repartir_Mensualizacion =  UD4#Gestion:T#" & ObjetivoM12 & "/12 * " & periodMultiplier & "", "A#R_CDR.Base",, "O#AdjInput",,,,,,,,,,,, True)
					api.Data.Calculate(" UD4#Repartir_Mensualizacion =  UD4#Gestion:T#" & ObjetivoM12 & "/12 * " & periodMultiplier & "", "A#730100",, "O#AdjInput",,,,,,,,,,,, True)
	...
	Sub Calc_RH021 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		If (Not api.Entity.HasChildren() And api.Cons.IsLocalCurrencyforEntity()) Then
			If CurYear > 2019 Then
				...
				If (sScenarioType = "Budget" _
				Or sScenarioType = "Forecast" ) Then					
					api.Data.ClearCalculatedData("A#RH021:S#" & api.Pov.Scenario.Name,True,True,True)
					api.Data.Calculate("A#RH021:S#" & api.Pov.Scenario.Name & ":F#OTROS:U1#HD01:U2#HD01=A#RH021:S#R:F#OTROS:U1#HD01:U2#HD01")
...
'					api.Data.Calculate("A#RH021:S#R_Extrapolado:F#OTROS:U1#HD01:U2#HD01=A#RH021:S#R:F#OTROS:U1#HD01:U2#HD01")
	...
	If (Not api.Entity.HasChildren() And api.Cons.IsLocalCurrencyforEntity()) Then
		...
		Dim DatoP09Ultimo = api.Data.GetDataCell("A#CR_Z:S#P09:T#POVPriorYearM12:O#Top:I#Top:V#YTD:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:U8#None").CellAmount
		Dim DatoP06Ultimo = api.Data.GetDataCell("A#CR_Z:S#P06:T#POVPriorYearM12:O#Top:I#Top:V#YTD:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:U8#None").CellAmount
		Dim DatoP03Ultimo = api.Data.GetDataCell("A#CR_Z:S#P03:T#POVPriorYearM12:O#Top:I#Top:V#YTD:F#Top:U1#Top:U2#Top:U3#Top:U4#Gestion:U5#Top:U6#Top:U7#Top:U8#None").CellAmount
		...
		Else If api.Pov.Scenario.Name = "O1" Then	
				...
				If DatoPrevistoO1 <> 0 Then
					...
					'Borramos RH028 y RH029	
					api.Data.ClearCalculatedData("A#RH029:S#" & api.Pov.Scenario.Name,True,True,True)
					api.Data.ClearCalculatedData("A#RH028:S#" & api.Pov.Scenario.Name,True,True,True)
					
					If DatoRealUltimo <> 0 Then	
					
					'Calculamos RH028 y RH029
					api.Data.Calculate("A#RH029:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#R:T#POVPriorYearM12")
					api.Data.Calculate("A#RH028:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#R:T#POVPriorYearM12 - A#RH027:S#" & api.Pov.Scenario.Name & "")
					
					Else If DatoP11Ultimo <> 0 Then																	
				
					'Calculamos RH028 y RH029
					api.Data.Calculate("A#RH029:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#P11:T#POVPriorYearM12")
					api.Data.Calculate("A#RH028:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#P11:T#POVPriorYearM12 - A#RH027:S#" & api.Pov.Scenario.Name & "")
				
					Else If DatoP09Ultimo <> 0 Then						
				
					'Calculamos RH028 y RH029
					api.Data.Calculate("A#RH029:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#P09:T#POVPriorYearM12")
					api.Data.Calculate("A#RH028:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#P09:T#POVPriorYearM12 - A#RH027:S#" & api.Pov.Scenario.Name & "")
				
					Else If DatoP06Ultimo <> 0	Then						
				
					'Calculamos RH028 y RH029
					api.Data.Calculate("A#RH029:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#P06:T#POVPriorYearM12")
					api.Data.Calculate("A#RH028:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#P06:T#POVPriorYearM12 - A#RH027:S#" & api.Pov.Scenario.Name & "")
				
					Else If DatoP03Ultimo <> 0	Then						
				
					'Calculamos RH028 y RH029
					api.Data.Calculate("A#RH029:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#P03:T#POVPriorYearM12")
					api.Data.Calculate("A#RH028:S#" & api.Pov.Scenario.Name & " = A#RH001:S#" & api.Pov.Scenario.Name & " - A#RH001:S#P03:T#POVPriorYearM12 - A#RH027:S#" & api.Pov.Scenario.Name & "")
...
'_______ feli 2023-03-21 comento las tres lineas siguientes		
...
'_______ feli 2023-03-21 añado las tres lienas siguientes
api.Data.Calculate("A#RH015:F#OTROS = MultiplyUnbalanced(A#RH024:F#OTROS, A#RH021:F#OTROS:O#Forms:I#None:U1#HD01:U2#HD01:U3#None:U4#None:U5#none:U6#none:U7#none, O#Forms:I#None:U1#HD01:U2#HD01:U3#None:U4#None:U5#none:U6#none:U7#none)")
api.Data.Calculate("A#RH015:F#FIJOS = MultiplyUnbalanced(A#RH024:F#FIJOS, A#RH021:F#OTROS:O#Forms:I#None:U1#HD01:U2#HD01:U3#None:U4#None:U5#none:U6#none:U7#none, O#Forms:I#None:U1#HD01:U2#HD01:U3#None:U4#None:U5#none:U6#none:U7#none)")
api.Data.Calculate("A#RH015:F#EVENTUALES = MultiplyUnbalanced(A#RH024:F#EVENTUALES, A#RH021:F#OTROS:O#Forms:I#None:U1#HD01:U2#HD01:U3#None:U4#None:U5#none:U6#none:U7#none, O#Forms:I#None:U1#HD01:U2#HD01:U3#None:U4#None:U5#none:U6#none:U7#none)")
'________feli 2023-03-21
	...
	Sub GtosGrales_CRJ2 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		'If (Not api.Entity.HasChildren()) Then
			...
			api.Data.Calculate("A#CR_J2:U3#2032=A#Calc_CRJ:U3#2032 * (-1)")	
			api.Data.Calculate("A#CR_J2:U3#2033=A#Calc_CRJ:U3#2033 * (-1)")	
			api.Data.Calculate("A#CR_J2:U3#2034=A#Calc_CRJ:U3#2034 * (-1)")				
...
'		api.Data.Calculate("A#CR_Q21:U3#8080=((A#Calc_CRJ:U3#8080 * (-1)) - A#623200:U3#8080 + A#682100:U3#8080) - A#CR_Q3:U3#8080")
'		api.Data.Calculate("A#CR_Q21:U3#8080:I#None=(A#CR_Q21:U3#8080:I#None + A#681100:U3#8080:I#None + A#680100:U3#8080:I#None - A#682100:U3#8080:I#None) - A#CR_Q3:U3#8080:I#None")
		...
		api.Data.Calculate("A#CR_Q21:U3#8080=A#CR_Q21:U3#8080 - A#CR_Q3:U3#8080")
		...
		If CurYear > 2020 Then					
			...
			If api.Entity.HasChildren() And api.Cons.IsLocalCurrencyforEntity() Then
				...
				Else
					api.Data.ClearCalculatedData("A#607010:U4#ELCE_REV",True,True,True)
					api.Data.ClearCalculatedData("A#601010:U4#ELCE_REV",True,True,True)
					api.Data.ClearCalculatedData("A#640210:U3#2099:U4#ELCE_REV",True,True,True)
					
					'Solo revierte cuentas base de la CR_Q	
					Dim CuentasQ2 As List(Of Member) = api.Members.GetBaseMembers(api.Pov.AccountDim.DimPk, api.Members.GetMemberId(dimtype.Account.Id, "CR_Q2"))			
					For Each Acc As Member In CuentasQ2 
						api.Data.ClearCalculatedData("A#" & Acc.Name.ToString & ":U3#8080:U4#ELCE_REV",True,True,True)
					Next
	...
	Sub GtosGrales_Q3i (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)		
		
		Dim timeId As Integer = api.Pov.Time.MemberPk.MemberId
		Dim CurYear As Integer = api.Time.GetYearFromId(timeId)
	
		Dim MemberList As List(Of MemberInfo) = BRApi.Finance.Metadata.GetMembersUsingFilter(si, "CONS_Natures", "U4#Agg_DataG.Base,U4#RetConMG.Base", True)			
		
		'api.Data.ClearCalculatedData("A#CR_Q3i",True,True,True,True)
		
		If (Not api.Entity.HasChildren()) Then
			
			'api.Data.ClearCalculatedData("A#CR_Q3i:U5#None:U6#None",True,True,True,True)					
			'brapi.errorlog.LogMessage(si, "Entra")
			
			For Each miMember As MemberInfo In MemberList		
				'brapi.errorlog.LogMessage(si, "Entra")
				api.Data.ClearCalculatedData("A#CR_Q3i:U4#" & miMember.Member.Name & ":U5#None:U6#None",True,True,True,True)
				api.Data.Calculate("A#CR_Q3i:U4#" & miMember.Member.Name & ":U5#None:U6#None = A#CR_Q2:U4#" & miMember.Member.Name & ":U5#None:U6#None - A#730100:U4#" & miMember.Member.Name & ":U5#None:U6#None",True)	
			Next	
			
'			api.Data.Calculate("A#CR_Q3i:U4#None:U5#None:U6#None = A#CR_Q2:U4#None:U5#None:U6#None - A#730100:U4#None:U5#None:U6#None",True)	
'			api.Data.Calculate("A#CR_Q3i:U4#RetSocG1_PL:U5#None:U6#None = A#CR_Q2:U4#RetSocG1_PL:U5#None:U6#None - A#730100:U4#RetSocG1_PL:U5#None:U6#None",True)	
						
			'brapi.errorlog.LogMessage(si, "Parent - " & api.Pov.Parent.name & " - Entity - " & api.Pov.Entity.name & " - Period - "& api.Pov.Time.Name)
		Else
			
			If CurYear < 2023 Then
				api.Data.ClearCalculatedData("A#CR_Q3i:U4#ELCE",True,True,True,True)
				api.Data.ClearCalculatedData("A#CR_Q3i:U4#ELCE_GES",True,True,True,True)
			Else				
				For Each miMember As MemberInfo In MemberList
					api.Data.Calculate("A#CR_Q3i:U4#ELCE = A#CR_Q2:U4#ELCE - A#730100:U4#ELCE",True)	
					api.Data.Calculate("A#CR_Q3i:U4#ELCE_GES = A#CR_Q2:U4#ELCE_GES - A#730100:U4#ELCE_GES",True)
					'20231219 ELI/FELI/JONATAN CAMBIO PORQUE NO RECOGIA ASIENTO DE P11 DE ACR
					api.Data.Calculate("A#CR_Q3i:U4#RetSoc1_PL = A#CR_Q2:U4#RetSoc1_PL - A#730100:U4#RetSoc1_PL",True)
				Next				
			End If
...
'		api.Data.ClearCalculatedData("A#CR_Q3i:U4#ELCE",True,True,True,True)
'		api.Data.ClearCalculatedData("A#CR_Q3i:U4#ELCE_REV",True,True,True,True)
'		api.Data.ClearCalculatedData("A#CR_Q3i:U4#Ajus2",True,True,True,True)
...
#Region "Member Formulas for R_CDR (Repartos)"

	Sub R_CDR_Calc_ABDE (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
				
		Dim MemberList As List(Of MemberInfo) = BRApi.Finance.Metadata.GetMembersUsingFilter(si, "CONS_Accounts", "A#R_CR_A.Base,A#R_CR_B.Base,A#R_CR_D.Base,A#R_CR_E.Base", True)
		
		If (Not api.Entity.HasChildren())
			
			'Limpiamos antes de calcular
			For Each miMember As MemberInfo In MemberList
				api.Data.ClearCalculatedData("A#" & miMember.Member.Name,True,True,True)
			Next
			
			api.Data.Calculate("A#R_CR_A1:U5#None:U6#None = A#CR_A1:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_A2:U5#None:U6#None = A#CR_A2:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_A3:U5#None:U6#None = A#CR_A3:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_A4:U5#None:U6#None = A#CR_A4:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_A9:U5#None:U6#None = A#CR_A9:U5#Top:U6#Top")
			
			api.Data.Calculate("A#R_CR_B1:U5#None:U6#None = A#CR_B1:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_B2:U5#None:U6#None = A#CR_B2:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_B3:U5#None:U6#None = A#CR_B3:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_B4:U5#None:U6#None = A#CR_B4:U5#Top:U6#Top")			
			
			api.Data.Calculate("A#R_CR_D1:U5#None:U6#None = A#CR_D1:U5#Top:U6#Top - A#CR_D1:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_D2:U5#None:U6#None = A#CR_D2:U5#Top:U6#Top - A#CR_D2:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_D3:U5#None:U6#None = A#CR_D3:U5#Top:U6#Top - A#CR_D3:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_D9:U5#None:U6#None = A#CR_D9:U5#Top:U6#Top - A#CR_D9:U5#Rules:U6#Net_Change")	
			api.Data.Calculate("A#R_CR_D9SG:U5#None:U6#None = A#CR_D:U5#Rules:U6#Net_Change")				
			
			api.Data.Calculate("A#R_CR_E1:U5#None:U6#None = A#CR_E1:U5#Top:U6#Top - A#CR_E1:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_E2:U5#None:U6#None = A#CR_E2:U5#Top:U6#Top - A#CR_E2:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_E9:U5#None:U6#None = A#CR_E9:U5#Top:U6#Top - A#CR_E9:U5#Rules:U6#Net_Change")	
			api.Data.Calculate("A#R_CR_E9SG:U5#None:U6#None = A#CR_E:U5#Rules:U6#Net_Change")								
				
		Else
			
			'Cálculo de Ajus2/ELCE_REV
			For Each miMember As MemberInfo In MemberList
				If Not miMember.Member.Name.EndsWith("SG")
					api.Data.Calculate("A#" & miMember.Member.Name & ":U4#Ajus2 = A#" & miMember.Member.Name.Replace("R_CR_","CR_") & ":U4#Ajus2")
					api.Data.Calculate("A#" & miMember.Member.Name & ":U4#ELCE_REV = A#" & miMember.Member.Name.Replace("R_CR_","CR_") & ":U4#ELCE_REV")
					api.Data.Calculate("A#" & miMember.Member.Name & ":O#AdjInput = A#" & miMember.Member.Name.Replace("R_CR_","CR_") & ":O#AdjInput")
				End If
			Next
	...
	Sub R_CDR_Calc_GHJWLM (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
				
		Dim MemberList As List(Of MemberInfo) = BRApi.Finance.Metadata.GetMembersUsingFilter(si, "CONS_Accounts", "A#R_CR_G.Base,A#R_CR_H,A#R_CR_J.Base,A#R_CR_L,A#R_CR_M", True)
		...
		'Limpiamos antes de calcular			
			...
			api.Data.Calculate("A#R_CR_G1:U5#None:U6#None = A#CR_G1:U5#Top:U6#Top - A#CR_G1:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_G2:U5#None:U6#None = A#CR_G2:U5#Top:U6#Top - A#CR_G2:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_G3:U5#None:U6#None = A#CR_G3:U5#Top:U6#Top - A#CR_G3:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_G9:U5#None:U6#None = A#CR_G9:U5#Top:U6#Top - A#CR_G9:U5#Rules:U6#Net_Change")	
			api.Data.Calculate("A#R_CR_G9SG:U5#None:U6#None = A#CR_G:U5#Rules:U6#Net_Change")				
			
			'nuevos calculo 2023-10-23
			'api.Data.Calculate("A#R_CR_G1:U5#None:U6#None:U7#None = A#CR_G1:U5#none:U6#none:U7#s1")
			'api.Data.Calculate("A#R_CR_G2:U5#None:U6#None:U7#None = A#CR_G2:U5#none:U6#none:U7#s1")
			'api.Data.Calculate("A#R_CR_G3:U5#None:U6#None:U7#None = A#CR_G3:U5#none:U6#none:U7#s1")
			'api.Data.Calculate("A#R_CR_G9:U5#None:U6#None:U7#None = A#CR_G9:U5#none:U6#none:U7#s1")	
			'api.Data.Calculate("A#R_CR_G9SG:U5#None:U6#None:U7#None = A#CR_G:U5#Rules:U6#Net_Change:U7#Top + A#CR_G:U5#none:U6#none:U7#S2 + A#CR_G:U5#none:U6#none:U7#S3")				
			''api.Data.Calculate("A#R_CR_G9SG:U5#None:U6#None:U7#None = A#CR_G:U5#Top:U6#top:U7#top - A#R_CR_G1:U5#None:U6#None:U7#None - A#R_CR_G2:U5#None:U6#None:U7#None - A#R_CR_G3:U5#None:U6#None:U7#None - A#R_CR_G9:U5#None:U6#None:U7#None")				
			
					
			api.Data.Calculate("A#R_CR_H:U5#None:U6#None = A#CR_H:U5#Top:U6#Top")
			
			api.Data.Calculate("A#R_CR_J1:U5#None:U6#None = A#CR_J1:U5#Top:U6#Top - A#CR_J1:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_J2:U5#None:U6#None = A#CR_J2:U5#Top:U6#Top - A#CR_J2:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_J3:U5#None:U6#None = A#CR_J3:U5#Top:U6#Top - A#CR_J3:U5#Rules:U6#Net_Change")
			api.Data.Calculate("A#R_CR_J4:U5#None:U6#None = A#CR_J4:U5#Top:U6#Top - A#CR_J4:U5#Rules:U6#Net_Change")						
			api.Data.Calculate("A#R_CR_J9SG:U5#None:U6#None = A#CR_J:U5#Rules:U6#Net_Change + A#CR_J9:U5#None:U6#None")		
			
			'nuevos calculo 2023-09-18
			'api.Data.Calculate("A#R_CR_J1:U5#None:U6#None:U7#None = A#CR_J1:U5#none:U6#none:U7#s1")
			'api.Data.Calculate("A#R_CR_J2:U5#None:U6#None:U7#None = A#CR_J2:U5#none:U6#none:U7#s1")
			'api.Data.Calculate("A#R_CR_J3:U5#None:U6#None:U7#None = A#CR_J3:U5#none:U6#none:U7#s1")
			'api.Data.Calculate("A#R_CR_J4:U5#None:U6#None:U7#None = A#CR_J4:U5#none:U6#none:U7#s1")	
			''api.Data.Calculate("A#R_CR_J9:U5#None:U6#None:U7#None = A#CR_J9:U5#none:U6#none:U7#s1")	
			'api.Data.Calculate("A#R_CR_J9SG:U5#None:U6#None:U7#None = A#CR_J:U5#Rules:U6#Net_Change:U7#Top + A#CR_J:U5#none:U6#none:U7#S2 + A#CR_J:U5#none:U6#none:U7#S3")				
			''api.Data.Calculate("A#R_CR_J9SG:U5#None:U6#None:U7#None = A#CR_J:U5#Top:U6#top:u7#top - A#R_CR_J1:U5#None:U6#None:U7#None - A#R_CR_J2:U5#None:U6#None:U7#None - A#R_CR_J3:U5#None:U6#None:U7#None - A#R_CR_J4:U5#None:U6#None:U7#None - A#R_CR_J9:U5#None:U6#None:U7#None")				
			
			'nuevos calculo 2023-10-23
						
			api.Data.Calculate("A#R_CR_L:U5#None:U6#None = A#CR_L:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_M:U5#None:U6#None = A#CR_M:U5#Top:U6#Top")
		...
		Else
			...
			For Each miMember As MemberInfo In MemberList
				...
				End If
			Next
			'20231018 ELI/FELI/Jonathan cambiamos porque en cierre real m09, el ajsute de acr no pintaba bien en la NUEVA CDR, duplicaba R_CR_J9SG
			'api.Data.Calculate("A#R_CR_J9SG:O#AdjInput = A#R_CR_J:O#AdjInput + A#CR_J9:O#AdjInput")
		
		End If	
	
	End Sub
	
	Sub R_CDR_Calc_NOQ (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
				
		Dim MemberList As List(Of MemberInfo) = BRApi.Finance.Metadata.GetMembersUsingFilter(si, "CONS_Accounts", "A#R_CR_N.Base,A#R_CR_O.Base,A#R_CR_Q1.Base,A#R_CR_Q21,A#R_CR_Q22,A#R_CR_Q23,A#R_CR_Q3A", True)
		...
		If (Not api.Entity.HasChildren())
			...
			api.Data.Calculate("A#R_CR_N1:U5#None:U6#None = A#CR_N1:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_N2:U5#None:U6#None = A#CR_N2:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_N3:U5#None:U6#None = A#CR_N3:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_N4:U5#None:U6#None = A#CR_N4:U5#Top:U6#Top")
			
			api.Data.Calculate("A#R_CR_O1:U5#None:U6#None = A#CR_O1:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_O2:U5#None:U6#None = A#CR_O2:U5#Top:U6#Top")	
			
			api.Data.Calculate("A#R_CR_Q11:U5#None:U6#None = A#CR_Q11:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_Q12:U5#None:U6#None = A#CR_Q12:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_Q13:U5#None:U6#None = A#CR_Q13:U5#Top:U6#Top")

			api.Data.Calculate("A#R_CR_Q21:U5#None:U6#None = A#CR_Q21:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_Q22:U5#None:U6#None = A#CR_Q22:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_Q23:U5#None:U6#None = A#CR_Q23:U5#Top:U6#Top")			
			api.Data.Calculate("A#R_CR_Q3A:U5#None:U6#None = A#CR_Q3A:U5#Top:U6#Top")	
		...
		Else
			...
			api.Data.Calculate("A#R_CR_Q3A:U4#ELCE = A#CR_Q3A:U4#ELCE")
			api.Data.Calculate("A#R_CR_Q3A:U4#ELCE_GES = A#CR_Q3A:U4#ELCE_GES")
			
		End If
	
	End Sub
	
	Sub R_CDR_Calc_SUWY (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
				
		Dim MemberList As List(Of MemberInfo) = BRApi.Finance.Metadata.GetMembersUsingFilter(si, "CONS_Accounts", "A#R_CR_S.Base,A#R_CR_U.Base,A#R_CR_W.Base,A#R_CR_Y.Base", True)
		...
		If (Not api.Entity.HasChildren())
			...
			api.Data.Calculate("A#R_CR_S1:U5#None:U6#None = A#CR_S1:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_S2:U5#None:U6#None = A#CR_S2:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_S3:U5#None:U6#None = A#CR_S3:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_S4:U5#None:U6#None = A#CR_S4:U5#Top:U6#Top")
			
			api.Data.Calculate("A#R_CR_U:U5#None:U6#None = A#CR_U:U5#Top:U6#Top")
			
			api.Data.Calculate("A#R_CR_WW1:U5#None:U6#None = A#CR_WW1:U5#Top:U6#Top")
			api.Data.Calculate("A#R_CR_WW2:U5#None:U6#None = A#CR_WW2:U5#Top:U6#Top")
			
			api.Data.Calculate("A#R_CR_Y:U5#None:U6#None = A#CR_Y:U5#Top:U6#Top")
...
#Region "Member Formulas for UD4"
	...
	Sub Ajus1_OLD (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
...
'			api.Data.Calculate("F#MOV:U4#Ajus1 = F#SDC:U4#Ajus1-F#TF:U4#Ajus1")	
	...
	Sub Ajus1 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		'If api.pov.Entity.Name = "LEGAL" And api.Cons.IsLocalCurrencyforEntity() Then
		If api.Entity.HasChildren() And api.Cons.IsLocalCurrencyforEntity() Then
			If api.Data.GetDataCell("A#920L:C#Local:O#Top:I#Top:F#TF:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
				api.Data.Calculate("A#252000:F#REC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#920L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
				api.Data.Calculate("A#252000:F#SDC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#920L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
			Else
				api.Data.Calculate("A#171000:F#REC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = -A#920L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
				api.Data.Calculate("A#171000:F#SDC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = -A#920L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
			End If
			api.Data.Calculate("A#920L:U4#Ajus1 = -A#920L:U4#RetAut_Legal")
			
			If api.Data.GetDataCell("A#921L:C#Local:O#Top:I#Top:F#TF:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
				api.Data.Calculate("A#430000:F#REC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#921L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
				api.Data.Calculate("A#430000:F#SDC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#921L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
			Else
				api.Data.Calculate("A#400000:F#REC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = -A#921L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
				api.Data.Calculate("A#400000:F#SDC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = -A#921L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
			End If
			api.Data.Calculate("A#921L:U4#Ajus1 = -A#921L:U4#RetAut_Legal")

			If api.Data.GetDataCell("A#922L:C#Local:O#Top:I#Top:F#TF:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
				api.Data.Calculate("A#542000:F#REC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#922L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
				api.Data.Calculate("A#542000:F#SDC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#922L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
			Else
				api.Data.Calculate("A#521000:F#REC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = -A#922L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
				api.Data.Calculate("A#521000:F#SDC:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = -A#922L:F#TF:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
			End If
			api.Data.Calculate("A#922L:U4#Ajus1 = -A#922L:U4#RetAut_Legal")
			
			If api.Data.GetDataCell("A#940L:C#Local:O#Top:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
				api.Data.Calculate("A#768000:F#None:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#940L:F#Top:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
			Else
				api.Data.Calculate("A#668000:F#None:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = -A#940L:F#Top:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None")
			End If
			api.Data.Calculate("A#940L:U4#Ajus1 = -A#940L:U4#RetAut_Legal")
...
'			 (A#INVER_DESINV:C#Local:O#Top:I#Top:F#INC:U1#Top:U2#Top:U3#Top:U4#Agregated_Data:U5#None:U6#None:U7#None:U8#None - A#INVER_DESINV:C#Local:O#Top:I#Top:F#DIS:U1#Top:U2#Top:U3#Top:U4#Agregated_Data:U5#None:U6#None:U7#None:U8#None)")
			...
			If api.Data.GetDataCell("A#950L:C#Local:O#Top:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#None:U6#None:U7#Top:U8#None").CellAmount + api.Data.GetDataCell("A#INVER_DESINV:C#Local:O#Top:I#Top:F#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
				api.Data.Calculate("A#768000:F#None:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#768000:F#None:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#Top:U6#Top:U7#Top:U8#None + A#950L:F#Top:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None + (A#INVER_DESINV:I#Top:F#INC:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None - A#INVER_DESINV:I#Top:F#DIS:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None + A#INVER_DESINV:I#Top:F#None:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None)")
			Else
				api.Data.Calculate("A#668000:F#None:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#None:U6#None:U7#None:U8#None = A#668000:F#None:I#None:U1#None:U2#None:U3#None:U4#Ajus1:U5#Top:U6#Top:U7#Top:U8#None - A#950L:F#Top:I#Top:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None - (A#INVER_DESINV:I#Top:F#INC:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None - A#INVER_DESINV:I#Top:F#DIS:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None + A#INVER_DESINV:I#Top:F#None:U1#Top:U2#Top:U3#Top:U4#RetAut_Legal:U5#Top:U6#Top:U7#Top:U8#None)")
			End If
			api.Data.Calculate("A#951L:U4#Ajus1 = -A#951L:U4#RetAut_Legal")
			api.Data.Calculate("A#952L:U4#Ajus1 = -A#952L:U4#RetAut_Legal")
			api.Data.Calculate("A#953L:U4#Ajus1 = -A#953L:U4#RetAut_Legal")
...
'			api.Data.Calculate("F#MOV:U4#Ajus1 = F#SDC:U4#Ajus1-F#TF:U4#Ajus1")	
	...
	Sub Ajus2_OLD (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		'If api.pov.Entity.Name = "LEGAL" And api.Cons.IsLocalCurrencyforEntity() Then
		If api.Entity.HasChildren() And api.Cons.IsLocalCurrencyforEntity() Then
	...
	Sub Ajus2 (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		...
		If api.Entity.HasChildren() And api.Cons.IsLocalCurrencyforEntity() Then
			...
			For Each UN As Member In UNBase
				...
				If Not UN.Name.ToString.substring(0,4).equals("Elim") Then
					If api.Data.GetDataCell("A#940L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
						api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#940L:F#Top:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
					Else
						api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = -A#940L:F#Top:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
					End If
					api.Data.Calculate("A#940L:U4#Ajus2:U1#"+UN.Name.ToString+" = -A#940L:U4#Elim_G:U1#"+UN.Name.ToString+"")

					If api.Data.GetDataCell("A#952L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount  > 0 Then
						api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top + A#952L:F#Top:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
					Else
						api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top -A#952L:F#Top:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
					End If
					api.Data.Calculate("A#952L:U4#Ajus2:U1#"+UN.Name.ToString+" = -A#952L:U4#Elim_G:U1#"+UN.Name.ToString+"")

				Else 'If UN starts with Elim
					If api.Data.GetDataCell("A#940L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
						api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#940L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
						api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
					Else
						api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = -A#940L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
						api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
					End If
					api.Data.Calculate("A#940L:U4#Ajus2:U1#"+UN.Name.ToString+" = - A#940L:U4#Elim_G:U1#"+UN.Name.ToString+"")

					If api.Data.GetDataCell("A#952L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
						'api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 =  A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 + A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
						api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top + A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
						'api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = - A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
					Else
						'api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 -A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
						api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top - A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
						'api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = - A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
					End If
					api.Data.Calculate("A#952L:U4#Ajus2:U1#"+UN.Name.ToString+" = - A#952L:U4#Elim_G:U1#"+UN.Name.ToString+"")
				End	If	
				...
				If Not UN.Name.ToString.equals("Elim_DN") And Not UN.Name.ToString.equals("Elim_Top") Then
					If Not UN.Name.ToString.substring(0,4).equals("Elim") Then
						If api.Data.GetDataCell("A#951L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
							'api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = A#951L:F#Top:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G")
							api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#951L:F#Top:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top + A#953L:F#INC:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top + A#953L:F#None:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
						Else
							'api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = -A#951L:F#Top:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G")
							api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = -A#951L:F#Top:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#953L:F#INC:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#953L:F#None:I#Top:U1#"+UN.Name.ToString+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
						End If
						api.Data.Calculate("A#951L:U4#Ajus2:U1#"+UN.Name.ToString+" = -A#951L:U4#Elim_G:U1#"+UN.Name.ToString+"")
						api.Data.Calculate("A#953L:U4#Ajus2:U1#"+UN.Name.ToString+" = -A#953L:U4#Elim_G:U1#"+UN.Name.ToString+"")
					Else 'If UN starts with Elim
						If api.Data.GetDataCell("A#951L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
							'api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#700000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
							api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top + A#953L:F#INC:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top + A#953L:F#None:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#700000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
							api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#600000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
						Else
							'api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = -A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#600000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
							api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top -A#953L:F#INC:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#953L:F#None:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#600000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
							api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#700000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
						End If
						api.Data.Calculate("A#951L:U4#Ajus2:U1#"+UN.Name.ToString+" = - A#951L:U4#Elim_G:U1#"+UN.Name.ToString+"")
						api.Data.Calculate("A#953L:U4#Ajus2:U1#"+UN.Name.ToString+" = - A#953L:U4#Elim_G:U1#"+UN.Name.ToString+"")
					End	If	
				Else 'if UN = Elim_DN
					If api.Data.GetDataCell("A#951L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
						'api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 =  A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 + A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
						'api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 =  A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 + A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G")
						api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None =  A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top + A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top + A#953L:F#INC:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top + A#953L:F#None:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
						api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#600000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
						api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#700000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
					Else
						'api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 -A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
						'api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 -A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G")
						api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top - A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top -A#953L:F#INC:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#953L:F#None:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
						api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#700000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
						api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#600000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
					End If
					api.Data.Calculate("A#951L:U4#Ajus2:U1#"+UN.Name.ToString+" = - A#951L:U4#Elim_G:U1#"+UN.Name.ToString+"")
	...
	'xxxxxxxx
			...
			For Each UN As Member In UNBaseENTE
				...
				If UN.Name.ToString.substring(0,4).equals("Elim") Then
					...
					If api.Data.GetDataCell("A#952L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
					'xx	api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 =  A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 + A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
						api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None =  A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top + A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
					'xx	api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = - A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
					Else
					'xx	api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 -A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
						api.Data.Calculate("A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#CR_668000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top -A#952L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top")
					'xx	api.Data.Calculate("A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = - A#CR_768000:F#None:I#None:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
					End If
					api.Data.Calculate("A#952L:U4#Ajus2:U1#"+UN.Name.ToString+" = - A#952L:U4#Elim_G:U1#"+UN.Name.ToString+"")
				End	If	
			...
			'	951L + 953L
				If Not UN.Name.ToString.equals("Elim_ENTES") Then
					If UN.Name.ToString.substring(0,4).equals("Elim") Then
						If api.Data.GetDataCell("A#951L:C#Local:O#Top:I#Top:F#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#None:U6#None:U7#Top:U8#None").CellAmount > 0 Then
						'xx	api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#700000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
							api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top + A#953L:F#INC:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top + A#953L:F#None:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#700000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
							api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#600000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
						Else
						'xx	api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2 = -A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G - A#600000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2")
							api.Data.Calculate("A#600000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = -A#951L:F#Top:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top -A#953L:F#INC:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#953L:F#None:I#Top:U1#"+UN.Name.ToString.substring(5)+":U2#Top:U3#Top:U4#Elim_G:U5#Top:U6#Top:U7#Top - A#600000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
							api.Data.Calculate("A#700000:F#None:I#E999:U1#"+UN.Name.ToString+":U2#None:U3#None:U4#Ajus2:U5#None:U6#None:U7#None = - A#700000:F#None:I#E999:U1#"+UN.Name.ToString.substring(5)+":U2#None:U3#None:U4#Ajus2:U5#Top:U6#Top:U7#Top")
						End If
						api.Data.Calculate("A#951L:U4#Ajus2:U1#"+UN.Name.ToString+" = - A#951L:U4#Elim_G:U1#"+UN.Name.ToString+"")
...
'	20250331: RES-GROUP	PL_CALC
'	***************************
	Sub PlCalcDirect (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		'If (Not api.Entity.HasChildren()) Then
			
			api.Data.ClearCalculatedData("A#DIRECT_Calc",True,True,True,True)
			api.Data.Calculate("A#DIRECT_Calc:U3#DIR=A#RPL_Calc:U3#DIR")
		'
		'End If

	End Sub
	
	Sub PlCalcIndirect (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		'If (Not api.Entity.HasChildren()) Then
			
			api.Data.ClearCalculatedData("A#INDIRECT_Calc",True,True,True,True)
			api.Data.Calculate("A#INDIRECT_Calc:U3#IND=A#RPL_Calc:U3#IND")
		'
		'End If

	End Sub
	
	Sub PlCalcOh (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		'If (Not api.Entity.HasChildren()) Then
			api.Data.ClearCalculatedData("A#OH_Calc",True,True,True,True)
			'Filtramos las entidades por el text1
			Dim U3Pk As DimPk = api.Dimensions.GetDim("SERV_Departments").DimPk
			Dim U3List As List(Of MemberInfo) = api.Members.GetMembersUsingFilter(U3Pk, "U3#OVH.Base.Where(Text1 Contains 'OH_Calc')", Nothing)			

			For Each U3Member As MemberInfo In U3List
				Dim U3Looped As String = U3Member.Member.Name
				api.Data.Calculate("A#OH_Calc:U3#" & U3Looped & "=A#RPL_Calc:U3#" & U3Looped & "")
			Next
		'
		'End If
	...
	Sub PlCalcDirectPRJ (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)
		
		If api.Pov.ScenarioType.Name.Equals("Forecast") Then
			api.Data.ClearCalculatedData("A#DIRECT",True,True,True,True)
			api.Data.Calculate("A#DIRECT:U3#DIR=A#RPL_Calc:U3#DIR")
		
		End If

	End Sub
	
	Sub PlCalcIndirectPRJ (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		If api.Pov.ScenarioType.Name.Equals("Forecast") Then
			
			api.Data.ClearCalculatedData("A#INDIRECT",True,True,True,True)
			api.Data.Calculate("A#INDIRECT:U3#IND=A#RPL_Calc:U3#IND")
		
		End If

	End Sub
	
	Sub PlCalcOhPRJ (ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal globals As BRGlobals, ByVal args As FinanceRulesArgs)

		If api.Pov.ScenarioType.Name.Equals("Forecast") Then
			
			api.Data.ClearCalculatedData("A#OH",True,True,True,True)
			'Filtramos las entidades por el text1
			Dim U3Pk As DimPk = api.Dimensions.GetDim("SERV_Departments").DimPk
			Dim U3List As List(Of MemberInfo) = api.Members.GetMembersUsingFilter(U3Pk, "U3#OVH.Base.Where(Text1 Contains 'OH_Calc')", Nothing)			
			...
			For Each U3Member As MemberInfo In U3List
				Dim U3Looped As String = U3Member.Member.Name
				api.Data.Calculate("A#OH:U3#" & U3Looped & "=A#RPL_Calc:U3#" & U3Looped & "")
			Next
