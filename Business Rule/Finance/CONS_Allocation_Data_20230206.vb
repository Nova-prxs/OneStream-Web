...
Namespace OneStream.BusinessRule.Finance.CONS_Allocation_Data_20230206
	
	Public Class MainClass
		
		Public dtDriver As New DataTable("Driver_Data")
		Public sCalc_DriverScenarioPeriod As String = String.Empty
		Public sCalc_DriverScenarioPeriod_Parchis As String = String.Empty
...
'			sbSQL.Append(" AND RuleSequence <= '06'")			
...
'			End If				
			...
			If (sSourceEntity_List.Contains(sEntity_MemberInfo(0)))																	
				...
				Me.GetDriverDataTable(si, api, sDriverScenario _
...
#Region "Drivers"
		...
		Sub GetDriverDataTable(ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal sDriverScenario As String, ByVal sDriverUD1 As String, ByVal sTargetUD1_List As List(Of MemberInfo), ByVal sDriverUD3 As String, ByVal sTargetUD3_List As List(Of MemberInfo), ByVal sDriverEntity As String, ByVal sDriverUD7 As String, ByVal sDriverAccount1 As String, ByVal sDriverAccount2 As String, ByVal sDriverAccount3 As String, ByVal sDriverAccount4 As String, ByVal sDriverAccount5 As String)	
...
'								If sEntity.Equals("E105") And sTargetUD3_Member.Member.Name.Equals("1010")
...
'									End If	
		...
		Function GetDriverData(ByVal si As SessionInfo, ByVal api As FinanceRulesApi, ByVal sEntity As String, ByVal sDriverUD1 As String, ByVal sTargetUD1Base As String, ByVal sSegment As String, ByVal sDriverUD3 As String, ByVal sTargetUD3Base As String, ByVal sDriverUD7 As String, ByVal sTargetUD7Base As String, ByVal sDriverAccount1 As String, ByVal sDriverAccount2 As String, ByVal sDriverAccount3 As String, ByVal sDriverAccount4 As String, ByVal sDriverAccount5 As String, ByVal sDriverAccount1Pond As String, ByVal sDriverAccount2Pond As String, ByVal sDriverAccount3Pond As String, ByVal sDriverAccount4Pond As String, ByVal sDriverAccount5Pond As String) As Double
...
'				If sEntity = "E123" And sTargetUD1Base = "EO04" Then
'					Brapi.ErrorLog.LogMessage(si, "Num: " & Convert.ToDouble(oDataDriverNum).ToString())
'					Brapi.ErrorLog.LogMessage(si, "Den: " & Convert.ToDouble(oDataDriverDen).ToString())
'				End If
...
'			If sEntity = "E105" And sTargetUD1Base = "EO03" Then
