				...
				Select Case args.FunctionType
					...
					Case Is = DashboardExtenderFunctionType.LoadDashboard
						If args.FunctionName.XFEqualsIgnoreCase("LoadDashboard") Then
							...
							Dim WorkspacePrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, "Horse.prm_HR_Workspace_Prefix")
							...
							If args.LoadDashboardTaskInfo.Reason = LoadDashboardReasonType.Initialize _
								...
								paramDashboard = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, $"Horse.prm_{WorkspacePrefix}_MainNavigation_Default")
							Else
...
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_HR_Scenario_Main") = "Planning"
'					If args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_HR_Scenario") = "Actual" Then _
'						loadDashboardTaskResult.ModifiedCustomSubstVars("prm_HR_Scenario") = "Budget"
'				Else
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_HR_Scenario_Main") = "Actual"
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_HR_Scenario") = "Actual"
'				End If
'			End If
		...
		Private Sub SetDashboardParametersOnClick(
			...
			'Control dashboard parameters
			'EXAMPLE
'			If paramDashboard = "HR_1_1" Then _
'				selectionChangedTaskResult.ModifiedCustomSubstVars("prm_HR_Request_Id") = ""
