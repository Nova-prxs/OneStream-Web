...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class STG_ETL_LOAD_CONTROL
		
		'Declare table name
		Dim tableName As String = "XFC_STG_ETL_LOAD_CONTROL"
            ...
            Try
				...
				BEGIN
					CREATE TABLE {tableName} (
						...
						OverlapPercentage DECIMAL(5,2) DEFAULT 50.00,
					    RefreshRange INT NULL,
					    ReferenceColumn NVARCHAR(128) NULL,
					    Enable BIT NOT NULL,
