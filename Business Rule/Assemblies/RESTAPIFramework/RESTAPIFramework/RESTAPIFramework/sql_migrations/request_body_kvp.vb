...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class request_body_kvp
		
		'Declare table name
		Dim tableName As String = "XFC_REST_MASTER_request_body_kvp"
            ...
            Try
				...
				BEGIN
					CREATE TABLE {tableName} (
					    request_id INT,
						body_key VARCHAR(255),
						body_value VARCHAR(MAX),
						in_use BIT,
						CONSTRAINT PK_{tableName} PRIMARY KEY CLUSTERED (request_id, body_key),
