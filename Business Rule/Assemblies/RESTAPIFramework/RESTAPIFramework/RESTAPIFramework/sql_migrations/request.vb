...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class request
		...
		'Declare table name
		Dim tableName As String = "XFC_REST_MASTER_request"
            ...
            Try
				...
				BEGIN
					CREATE TABLE {tableName} (
					    ...
					    next_link_key VARCHAR(255) DEFAULT '',
						top_param_name VARCHAR(255) DEFAULT '',
						skip_param_name VARCHAR(255) DEFAULT '',
						data_limit INTEGER DEFAULT 0,
					    data_key VARCHAR(255) DEFAULT '',
						table_to_populate VARCHAR(255) DEFAULT 'none',
