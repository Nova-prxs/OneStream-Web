...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class request_column_mapping
		
		'Declare table name
		Dim tableName As String = "XFC_REST_MASTER_request_column_mapping"
            ...
            Try
				...
				BEGIN
					CREATE TABLE {tableName} (
						...
						CONSTRAINT PK_{tableName} PRIMARY KEY CLUSTERED (request_id, source_column, target_column),
						CONSTRAINT AK_RequestIDSource UNIQUE(request_id, source_column),
						CONSTRAINT AK_RequestIDTarget UNIQUE(request_id, target_column),
