				...
				Select Case args.FunctionType
					...
					Case Is = DashboardExtenderFunctionType.LoadDashboard
						If args.FunctionName.XFEqualsIgnoreCase("LoadDashboard") Then
							...
							Dim WorkspacePrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, "WorkspaceTemplateName.prm_WorkspaceTemplateName_Workspace_Prefix")
							...
							If args.LoadDashboardTaskInfo.Reason = LoadDashboardReasonType.Initialize _
								...
								paramDashboard = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, $"WorkspaceTemplateName.prm_{WorkspacePrefix}_MainNavigation_Default")
							Else
...
'					If args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_WorkspaceTemplateName_Scenario") = "Actual" Then _
...
'			End If
		...
		Private Sub SetDashboardParametersOnClick(
			...
			'Control dashboard parameters
			'EXAMPLE
'			If paramDashboard = "WorkspaceTemplateName_1_1" Then _
