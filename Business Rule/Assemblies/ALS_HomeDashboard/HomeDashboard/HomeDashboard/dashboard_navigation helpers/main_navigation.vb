				...
				Select Case args.FunctionType
					...
					Case Is = DashboardExtenderFunctionType.LoadDashboard
						If args.FunctionName.XFEqualsIgnoreCase("LoadDashboard") Then
							...
							Dim WorkspacePrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, "ALS_HomeDashboard.prm_HomeDashboard_Workspace_Prefix")
							...
							If args.LoadDashboardTaskInfo.Reason = LoadDashboardReasonType.Initialize _
								...
								paramDashboard = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, $"ALS_HomeDashboard.prm_{WorkspacePrefix}_MainNavigation_Default")
							Else
							...
							#Region "Enlazar con Landing Page"
							'Relacionar Dashboard con Landing Page
							Dim paramDashboard_LandingPage = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, $"ALS_LandingPage.prm_LandingPage_Flag")
							If paramDashboard_LandingPage = "LandingPage_2_2"
								'Actual
								paramDashboard = "HomeDashboard_2_1_1"
							Else If paramDashboard_LandingPage = "LandingPage_2_3"
								'Forecast
								paramDashboard = "HomeDashboard_5_1"
							Else If paramDashboard_LandingPage = "LandingPage_2_4"
								'Budget
								paramDashboard = "HomeDashboard_4_1_1"
							Else If paramDashboard_LandingPage = "LandingPage_2_5"
								'Reporting
								paramDashboard = "HomeDashboard_3_1_1"
							End If
							BRApi.Dashboards.Parameters.SetLiteralParameterValue(si, False, Nothing, $"ALS_LandingPage.prm_LandingPage_Flag", "None")
							#End Region
...
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_HomeDashboard_Scenario_Main") = "Planning"
'					If args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_HomeDashboard_Scenario") = "Actual" Then _
'						loadDashboardTaskResult.ModifiedCustomSubstVars("prm_HomeDashboard_Scenario") = "Budget"
'				Else
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_HomeDashboard_Scenario_Main") = "Actual"
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_HomeDashboard_Scenario") = "Actual"
'				End If
'			End If
		...
		Private Sub SetDashboardParametersOnClick(
			...
			'Control dashboard parameters
			'EXAMPLE
'			If paramDashboard = "HomeDashboard_1_1" Then _
'				selectionChangedTaskResult.ModifiedCustomSubstVars("prm_HomeDashboard_Request_Id") = ""
