				...
				Select Case args.FunctionType
					...
					Case Is = DashboardExtenderFunctionType.LoadDashboard
						If args.FunctionName.XFEqualsIgnoreCase("LoadDashboard") Then
							...
							Dim WorkspacePrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, "prm_RND_Workspace_Prefix")
							...
							If args.LoadDashboardTaskInfo.Reason = LoadDashboardReasonType.Initialize _
								...
								paramDashboard = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"prm_{WorkspacePrefix}_MainNavigation_Default")
							Else
		...
		Private Sub SetDashboardParameters(
			...
			If level = 1 Then
				...
				If activeDashboardNumber = 3 Then
					...
					loadDashboardTaskResult.ModifiedCustomSubstVars($"prm_Investments_Navigation_Header_Right") = "RND_Forecast_Navigation_Header_Right"
				...
				Else If activeDashboardNumber = 4 Then
					...
					loadDashboardTaskResult.ModifiedCustomSubstVars($"prm_Investments_Navigation_Header_Right") = "RND_Budget_Navigation_Header_Right"
				...
				Else
					...
					loadDashboardTaskResult.ModifiedCustomSubstVars($"prm_Investments_Navigation_Header_Right") = "RND_Actual_Navigation_Header_Right"
				End If
			...
			Else If level = 2 Then
				...
				'If no company selected, they can't edit cells
