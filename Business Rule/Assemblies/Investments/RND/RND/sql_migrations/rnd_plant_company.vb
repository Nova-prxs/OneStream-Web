...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class rnd_plant_company
		
		'Declare table name
		Dim tableName As String = "XFC_RND_MASTER_plant_company"
				...
				Dim upQuery As String = $"
					...
					USING (
					    SELECT
					        pc.plant_name,
							c.id AS company_id
					    FROM XFC_RND_RAW_plant_company pc
						LEFT JOIN XFC_INV_MASTER_company c ON pc.company_name = c.name
					) AS source
