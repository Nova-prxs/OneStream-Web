...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class rnd_project_expense
		
		'Declare table name
		Dim tableName As String = "XFC_RND_FACT_project_expense"
            ...
            Try
				...
				Dim upQuery As String = $"
					...
					ON target.project_id = source.project_id
						...
						AND target.cost_nature = source.cost_nature
