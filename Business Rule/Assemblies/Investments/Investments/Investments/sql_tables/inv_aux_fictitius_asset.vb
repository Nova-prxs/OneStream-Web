...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
		Public Class inv_aux_fictitious_assets
		
		'Declare table name
		Dim tableName As String = "XFC_INV_AUX_Fictitious_Assets"
				...
				Dim upQuery As String = $"
					...
					BEGIN
						CREATE TABLE  {tableName} (
						    ...
						    year INT NOT NULL,
						    CONSTRAINT PK_Fictitious_Assets PRIMARY KEY (asset_id, project_id, scenario, year)
						);
					END;
				"
