...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class inv_project_capitalization
            ...
            Try
				...
				Dim upQuery As String = $"
					...
					BEGIN
						...
						CREATE INDEX idx_project_id_year ON XFC_INV_FACT_project_capitalization (project_id, year);
						CREATE INDEX idx_project_id_year_scenario ON XFC_INV_FACT_project_capitalization (project_id, year, scenario);
						CREATE INDEX idx_scenario ON XFC_INV_FACT_project_capitalization (scenario);
