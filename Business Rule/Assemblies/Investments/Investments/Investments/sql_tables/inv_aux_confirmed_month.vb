...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class inv_aux_confirmed_month
		
		'Declare table name
		Dim tableName As String = "XFC_INV_AUX_confirmed_month"
				...
				Dim upQuery As String = $"
					...
					BEGIN
						CREATE TABLE {tableName} (
							...
							M11 BIT,
							M12 BIT
							CONSTRAINT PK_{tableName} PRIMARY KEY (company_id, type, year, scenario)
						)
					END;
				"
