...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class inv_aux_confirmed_scenario_year
		
		'Declare table name
		Dim tableName As String = "XFC_INV_AUX_confirmed_scenario_year"
				...
				Dim upQuery As String = $"
					...
					BEGIN
						CREATE TABLE {tableName} (
							...
							year INT NOT NULL,
							scenario VARCHAR(55) NOT NULL,
							is_confirmed VARCHAR(55)
							CONSTRAINT PK_{tableName} PRIMARY KEY (company_id, year, scenario)
						)
					END;
				"
