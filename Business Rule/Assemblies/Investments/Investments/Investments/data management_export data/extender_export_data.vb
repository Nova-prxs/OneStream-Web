			...
			Try
				Select Case args.FunctionType
					...
					Case Is = ExtenderFunctionType.ExecuteDataMgmtBusinessRuleStep
						...
						Dim WSPrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, "Investments.prm_Workspace_Prefix")
						...
						'Modify File Name
						If sheetName.Contains("Projects Cash") Then
							sheetName = sheetName & " " & parameterDict("paramCompany") & " " & parameterDict("paramYear") & " " & parameterDict("paramScenario")
						End If
						'Create file
