...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName.BusinessRule.Spreadsheet.TRS_CashFlowForecasting_OF_IF_Global_Average
...
End Function
	...
	Private Function GetCashFlowForecastingAverageReport(ByVal si As SessionInfo, ByVal args As SpreadsheetArgs) As TableView
			...
			' Define all entities (same as CF_CB_Global)
			...
			Dim horseGroupEntities As String() = {
				...
				Using dbConn As DbConnInfo = BRApi.Database.CreateApplicationDbConnInfo(si)
					...
					' ====================================
					' STEP 3: Calculate Accumulated Cashflow (same logic as OF_IF_Global)
					' ====================================
					...
					For Each kvp As KeyValuePair(Of String, Integer) In allEntities
						...
						For weekNum As Integer = 1 To maxWeeks
							...
							accumulatedValue += weekTotal
							entityData(entity)(weekNum) = accumulatedValue
						Next
					Next
					...
					' Calculate average from week 1 to currentWeek
