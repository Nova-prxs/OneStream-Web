...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName.BusinessRule.Extender.TRS_ReportGenerator_TreasuryMonitoring
    Public Class MainClass
                ...
                Select Case args.FunctionType
                    Case Is = ExtenderFunctionType.ExecuteDataMgmtBusinessRuleStep
                        ...
                        If Not String.IsNullOrEmpty(functionName) Then
                            If functionName.Equals("GenerateMonitoringReport", StringComparison.InvariantCultureIgnoreCase) Then
                                Return GenerateMonitoringReport(si, args)
                            End If
                        End If
                End Select
        ...
        Private Function GenerateMonitoringReport(ByVal si As SessionInfo, ByVal args As ExtenderArgs) As Object
            Try
                ' 1. Get Parameters
                ...
                ' 2. Get Data
                Dim dt As DataTable = GetTreasuryData(si, paramWeek, paramYear)
                
                If dt.Rows.Count = 0 Then
                End If

                ' 3. Load File (Using the TEMPLATE as source, not the output)
                Dim templatePath As String = "Documents/Public/Treasury/Extensible Document/Treasury_Monitoring_Report.xlsx"
                Dim outputPath As String = "Documents/Public/Treasury/Treasury_Monitoring_Report.xlsx"
                ...
                Using ms As New MemoryStream()
                    ...
                    Using doc As SpreadsheetDocument = SpreadsheetDocument.Open(ms, isEditable:=True)
                        ...
                        ' LIMPIAR DATOS ANTIGUOS (Filas > 3)
                        ...
                        ' ==========================================================================================
                        ' ACTUALIZAR NAMED RANGE: TreasuryMonitoring_Report - Dinámico según filas de datos
                        ' ==========================================================================================
                        ...
                        Dim namedRangeName As String = "TreasuryMonitoring_Report"
                        ...
                        ' Actualizar solo los Named Ranges necesarios (TreasuryMonitoring_Report y Print_Area)
                    ...
                    Dim newFileInfo As New XFFileInfo(FileSystemLocation.ApplicationDatabase, "Treasury_Monitoring_Report.xlsx", "Documents/Public/Treasury")
        ...
        Private Function GetTreasuryData(ByVal si As SessionInfo, ByVal week As String, ByVal year As String) As DataTable
            ...
            Using dbConnApp As DbConnInfo = BRApi.Database.CreateApplicationDbConnInfo(si)
                ' Cambiado a True porque es una consulta SELECT
