...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName.BusinessRule.Spreadsheet.TRS_CashDebtPositionHeader
	Public Class MainClass
			...
			Try
				Select Case args.FunctionType
					...
					Case Is = SpreadsheetFunctionType.GetTableView
						Return Me.GetCashDebtPositionHeaderReport(si, args)
		...
		#Region "Cash Debt Position Header Report"

		Private Function GetCashDebtPositionHeaderReport(ByVal si As SessionInfo, ByVal args As SpreadsheetArgs) As TableView
			Try
				...
				Try
					Using dbConn As DbConnInfo = BRApi.Database.CreateApplicationDbConnInfo(si)
						...
						Dim checkSql As String = TRS_SQL_Repository.GetConfirmationStatusQuery("CashDebt")
				...
				titleRow.Items.Add("Field", New TableViewColumn() With {.Value = $"{paramEntity.ToUpper()} - Cash and Debt position report", .IsHeader = True})
				...
				' Add blank row for separation with confirmation status
				...
				blankRow1.Items.Add("Status", New TableViewColumn() With {.Value = confirmationStatus, .IsHeader = False})
				...
				entityRow.Items.Add("Value", New TableViewColumn() With {.Value = paramEntity.ToUpper(), .IsHeader = False})
				entityRow.Items.Add("Spacer", New TableViewColumn() With {.Value = "", .IsHeader = False})
				entityRow.Items.Add("Status", New TableViewColumn() With {.Value = "", .IsHeader = False})
				...
				startingWeekRow.Items.Add("Spacer", New TableViewColumn() With {.Value = "", .IsHeader = False})
				startingWeekRow.Items.Add("Status", New TableViewColumn() With {.Value = "", .IsHeader = False})
				...
				endingWeekRow.Items.Add("Spacer", New TableViewColumn() With {.Value = "", .IsHeader = False})
				endingWeekRow.Items.Add("Status", New TableViewColumn() With {.Value = "", .IsHeader = False})
				...
				endOfMonthRow.Items.Add("Spacer", New TableViewColumn() With {.Value = "", .IsHeader = False})
				endOfMonthRow.Items.Add("Status", New TableViewColumn() With {.Value = "", .IsHeader = False})
				...
				statusRow.Items.Add("Spacer", New TableViewColumn() With {.Value = "", .IsHeader = False})
				statusRow.Items.Add("Status", New TableViewColumn() With {.Value = "", .IsHeader = False})
				...
				millEurRow.Items.Add("Spacer", New TableViewColumn() With {.Value = "", .IsHeader = False})
				millEurRow.Items.Add("Status", New TableViewColumn() With {.Value = "", .IsHeader = False})
