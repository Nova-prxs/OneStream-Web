...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName.BusinessRule.Spreadsheet.TRS_CashDebtPositionHeader_Global
	Public Class MainClass
		...
		Private Function GetCashDebtPositionHeaderGlobalReport(ByVal si As SessionInfo, ByVal args As SpreadsheetArgs) As TableView
			Try
				...
				Dim paramEntity As String = "HORSE GLOBAL"
