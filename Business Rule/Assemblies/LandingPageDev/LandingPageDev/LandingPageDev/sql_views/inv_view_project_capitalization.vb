					...
					IF OBJECT_ID(N'{viewName}', N'V') IS NULL
						BEGIN
							EXEC('CREATE VIEW {viewName} AS
								SELECT
							        pma.project_id AS project_id,
									pma.scenario AS scenario,
									pma.year AS year,
									pma.amount_m1 AS amount_m1,
									pma.amount_m2 AS amount_m2,
									pma.amount_m3 AS amount_m3,
									pma.amount_m4 AS amount_m4,
									pma.amount_m5 AS amount_m5,
									pma.amount_m6 AS amount_m6,
									pma.amount_m7 AS amount_m7,
									pma.amount_m8 AS amount_m8,
									pma.amount_m9 AS amount_m9,
									pma.amount_m10 AS amount_m10,
									pma.amount_m11 AS amount_m11,
									pma.amount_m12 AS amount_m12,
									CASE
									...
									p.poi_poe,
									(
										COALESCE(pma.amount_m1, 0)
										+ COALESCE(pma.amount_m2, 0)
										+ COALESCE(pma.amount_m3, 0)
										+ COALESCE(pma.amount_m4, 0)
										+ COALESCE(pma.amount_m5, 0)
										+ COALESCE(pma.amount_m6, 0)
										+ COALESCE(pma.amount_m7, 0)
										+ COALESCE(pma.amount_m8, 0)
										+ COALESCE(pma.amount_m9, 0)
										+ COALESCE(pma.amount_m10, 0)
										+ COALESCE(pma.amount_m11, 0)
										+ COALESCE(pma.amount_m12, 0)
									) AS amount_year,
									p.total_requirement,
									COALESCE(
										(
