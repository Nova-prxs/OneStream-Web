...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class inv_aux_modified_projection
		
		'Declare table name
		Dim tableName As String = "XFC_INV_AUX_modified_projection"
				...
				Dim upQuery As String = $"
					...
					BEGIN
						CREATE TABLE {tableName} (
							...
							CONSTRAINT PK_{tableName} PRIMARY KEY (type, year, scenario, project_id)
						)
					END;
				"
