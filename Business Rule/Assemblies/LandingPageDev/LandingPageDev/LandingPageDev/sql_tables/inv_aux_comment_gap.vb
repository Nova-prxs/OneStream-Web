...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class inv_aux_comment_gap
		
		'Declare table name
		Dim tableName As String = "XFC_INV_AUX_comment_gap"
				...
				Dim upQuery As String = $"
					...
					BEGIN
						CREATE TABLE {tableName} (
							...
							month INT NOT NULL,
							comment_Actual VARCHAR(MAX),
							comment_Planning VARCHAR(MAX)
							CONSTRAINT PK_{tableName} PRIMARY KEY (company_id, type, year, scenario, month)
						)
					END;
				"
