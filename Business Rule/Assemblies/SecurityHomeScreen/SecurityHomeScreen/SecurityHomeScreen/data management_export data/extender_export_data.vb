			...
			Try
				Select Case args.FunctionType
					...
					Case Is = ExtenderFunctionType.ExecuteDataMgmtBusinessRuleStep
						...
						Dim WSPrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, "SecurityHomeScreen.prm_SecurityHomeScreen_Workspace_Prefix")
