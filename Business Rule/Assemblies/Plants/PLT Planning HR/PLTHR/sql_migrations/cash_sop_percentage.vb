...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class cash_sop_percentage
		
		'Declare table name
		Dim tableName As String = "XFC_INV_MASTER_project_cash_sop_percentage"
				...
				Dim upQuery As String = $"
					...
					BEGIN
						CREATE TABLE {tableName} (	
							sop_month_difference DECIMAL(18,2) NOT NULL,
							poe_percentage DECIMAL(18,2) NOT NULL,
							poi_percentage DECIMAL(18,2) NOT NULL
						)
					END;
				"
