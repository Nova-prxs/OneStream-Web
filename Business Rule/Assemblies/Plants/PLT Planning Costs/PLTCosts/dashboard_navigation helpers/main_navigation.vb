				...
				Select Case args.FunctionType									
					...
					Case Is = DashboardExtenderFunctionType.LoadDashboard
						If args.FunctionName.XFEqualsIgnoreCase("LoadDashboard") Then
							...
							Dim WorkspacePrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, "Plants.prm_PLTCosts_Workspace_Prefix")
							...
							If args.LoadDashboardTaskInfo.Reason = LoadDashboardReasonType.Initialize _
								...
								paramDashboard = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLTCosts_MainNavigation_Default")
							Else
							...
							If (paramDashboard.Contains("PLTCosts_1_")) Then
								...
								loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTCosts_scenario_selected") = "Actual"
								
								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_year_selected") = "" Or args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_scenario_selected").Contains("Actual")=False)
									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTCosts_year") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_year_N")
								End If	
								
							Else If (paramDashboard.Contains("PLTCosts_2_")) Then
								...
								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_scenario_selected") = "" Or args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_scenario_selected").Contains("R")=False)
									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTCosts_scenario_selected") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_scenario_forecast")
								End If
								
								loadDashboardTaskResult.ModifiedCustomSubstVars("Plants.PLT_LoadFiles_prm_scenario_list") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"prm_PLTCosts_scenario_selected")
								loadDashboardTaskResult.ModifiedCustomSubstVars("Plants.PLT_LoadFiles_prm_scenario") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"prm_PLTCosts_scenario_selected")
								
								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_year_selected") = "" Or args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_scenario_selected").Contains("R")=False)
									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTCosts_year_selected") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_year_N")
									loadDashboardTaskResult.ModifiedCustomSubstVars("Plants.PLT_LoadFiles_prm_year") = (BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False,  $"Plants.prm_PLT_year_N")).ToString
								End If								
								
							Else
								Me.setGridViewParameters(si, "1", loadDashboardTaskResult)
								
								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_scenario_selected") = "" Or args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_scenario_selected").Contains("B")=False)
									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTCosts_scenario_selected") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_scenario_budget")
								End If	
								
								loadDashboardTaskResult.ModifiedCustomSubstVars("Plants.PLT_LoadFiles_prm_scenario_list") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"prm_PLTCosts_scenario_selected")
								loadDashboardTaskResult.ModifiedCustomSubstVars("Plants.PLT_LoadFiles_prm_scenario") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"prm_PLTCosts_scenario_selected")
								
								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_year_selected") = ""  Or args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTCosts_scenario_selected").Contains("B")=False)
									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTCosts_year_selected") = (BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_year_N") + 1).ToString
