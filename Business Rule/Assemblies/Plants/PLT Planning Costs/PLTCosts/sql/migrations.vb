...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class Migrations
		...
		Dim tables As New List(Of Object) From {
			New Workspace.__WsNamespacePrefix.__WsAssemblyName.financial_figures,
			New Workspace.__WsNamespacePrefix.__WsAssemblyName.project_cash,
			New Workspace.__WsNamespacePrefix.__WsAssemblyName.project,
			New Workspace.__WsNamespacePrefix.__WsAssemblyName.raw_project,
			New Workspace.__WsNamespacePrefix.__WsAssemblyName.asset_category,
			New Workspace.__WsNamespacePrefix.__WsAssemblyName.asset,
			New Workspace.__WsNamespacePrefix.__WsAssemblyName.cash_sop_percentage
		}
