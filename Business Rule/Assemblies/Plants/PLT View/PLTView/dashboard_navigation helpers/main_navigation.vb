				...
				Select Case args.FunctionType									
					...
					Case Is = DashboardExtenderFunctionType.LoadDashboard
						If args.FunctionName.XFEqualsIgnoreCase("LoadDashboard") Then
							...
							Dim WorkspacePrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, "Plants.prm_PLTView_Workspace_Prefix")
							...
							If args.LoadDashboardTaskInfo.Reason = LoadDashboardReasonType.Initialize _
								...
								paramDashboard = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLTView_MainNavigation_Default")
							Else
							...
							#Region "LoadFiles navigation"
'							If (paramDashboard.Contains("PLTView_1_")) Then
...
'								loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_scenario_selected") = "Actual"
								
'								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTView_year_selected") = "")
'									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_year") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_year_N")
'								End If	
								
'							Else If (paramDashboard.Contains("PLTView_2_")) Then
...
'								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTView_scenario_selected") = "" Or args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTView_scenario_selected").Contains("R")=False)
'									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_scenario_selected") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_scenario_forecast")
'								End If
								
'								loadDashboardTaskResult.ModifiedCustomSubstVars("Plants.PLT_LoadFiles_prm_scenario_list") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"prm_PLTView_scenario_selected")
'								loadDashboardTaskResult.ModifiedCustomSubstVars("Plants.PLT_LoadFiles_prm_scenario") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"prm_PLTView_scenario_selected")
								
'								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTView_year_selected") = "")
'									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_year_selected") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_year_N")
'								End If								
'							Else
'								Me.setGridViewParameters(si, "1", loadDashboardTaskResult)
								
'								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTView_scenario_selected") = "" Or args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTView_scenario_selected").Contains("B")=False)
'									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_scenario_selected") = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_scenario_budget")
'								End If	
...
'								If (args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_PLTView_year_selected") = "")
'									loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_year_selected") = (BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLT_year_N") + 1).ToString
'								End If																
...
'							End If		
							...
							Dim selectedAccounts As String = args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue($"prm_PLTView_account")
							Dim selectedProducts As String = args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue($"prm_PLTView_references")
							' brapi.ErrorLog.LogMessage(si, $"Acc: {selectedAccounts}")
							' brapi.ErrorLog.LogMessage(si, $"Prd: {selectedProducts}")
							If(selectedAccounts="All" Or selectedAccounts="") Then 
								loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_acc_img") = "f_PLTView_filter_plus.png" 
							Else 
								loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_acc_img") = "f_PLTView_filter.png" 
							End If
							If(selectedProducts="All" Or selectedProducts="") Then 
								loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_prd_img") = "f_PLTView_filter_plus.png" 
							Else 
								loadDashboardTaskResult.ModifiedCustomSubstVars("prm_PLTView_prd_img") = "f_PLTView_filter.png" 
							End If
					...
					Case Is = DashboardExtenderFunctionType.ComponentSelectionChanged
						...
						If args.FunctionName.XFEqualsIgnoreCase("OpenDashboard")
							...
							' Dim selectedAccounts As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLTView_account")
							' Dim selectedProducts As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, $"Plants.prm_PLTView_references")
							' brapi.ErrorLog.LogMessage(si, $"Acc -2: {selectedAccounts}")
							' brapi.ErrorLog.LogMessage(si, $"Prd -2: {selectedProducts}")
							' If(selectedAccounts="All" Or selectedAccounts="") Then 
							' 	selectionChangedTaskResult.ModifiedCustomSubstVars("prm_PLTView_acc_img") = "f_PLTView_filter_plus.png" 
							' Else 
							' 	selectionChangedTaskResult.ModifiedCustomSubstVars("prm_PLTView_acc_img") = "f_PLTView_filter.png" 
							' End If
							' If(selectedProducts="All" Or selectedProducts="") Then 
							' 	selectionChangedTaskResult.ModifiedCustomSubstVars("prm_PLTView_prd_img") = "f_PLTView_filter_plus.png" 
							' Else 
							' 	selectionChangedTaskResult.ModifiedCustomSubstVars("prm_PLTView_prd_img") = "f_PLTView_filter.png" 
							' End If
