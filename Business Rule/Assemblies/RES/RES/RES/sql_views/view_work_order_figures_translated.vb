...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class view_work_order_figures_translated
		
		'Declare table name
		Dim tableName As String = "XFC_RES_FACT_work_order_figures"
		Dim viewName As String = "XFC_RES_VIEW_work_order_figures_translated"
				...
				BEGIN
					EXEC('
						...
						WITH ytd_gbp AS (
							...
							FROM XFC_RES_VIEW_work_order_figures_ytd pfytd
