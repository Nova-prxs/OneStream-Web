...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class serv_allocations_main
		
		'Declare table name
		Dim tableName As String = "XFC_RES_SERV_ALLOCATIONS"
            ...
            Try
				...
				BEGIN
					CREATE TABLE {tableName} (
                        rule_number VARCHAR(255),
                        description VARCHAR(255),
                        sequence VARCHAR(255),
                        enabled BIT,
                        time VARCHAR(255),
                        technology_source VARCHAR(255),
                        technology_target VARCHAR(255),
                        entity_source VARCHAR(255),
                        entity_target VARCHAR(255),
                        cost_center_source VARCHAR(255),
                        cost_center_target VARCHAR(255),
                        account_source VARCHAR(255),
                        account_target VARCHAR(255),
                        account_driver VARCHAR(255),
                        technology_driver VARCHAR(255),
                        scenario_driver VARCHAR(255)
                    );
				END;
				"
