...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class raw_fxrate
		
		'Declare table name
		Dim tableName As String = "XFC_RES_RAW_fxrate"
	    ...
	    Try
	        ...
	        BEGIN
	            CREATE TABLE XFC_RES_RAW_fxrate (
	                year INT NOT NULL,
	                month INT NOT NULL,
	                ...
	                CONSTRAINT PK_XFC_RES_RAW_fxrate PRIMARY KEY (year, month, type, source, target)
	            );
	        END;
	        "
