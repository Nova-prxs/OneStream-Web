...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class aux_scenario_fxratetype
		
		'Declare table name
		Dim tableName As String = "XFC_RES_AUX_scenario_fxratetype"
	    ...
	    Try
	        ...
	        BEGIN
	            CREATE TABLE {tableName} (
	                scenario VARCHAR(255) PRIMARY KEY,
					fxratetype_rev VARCHAR(255),
					fxratetype_bal VARCHAR(255),
	            );
	        END;
	        "
