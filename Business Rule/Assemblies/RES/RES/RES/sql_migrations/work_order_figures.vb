...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class work_order_figures
            ...
            Try
				...
				BEGIN
					CREATE TABLE {tableName} (
						...
						ud3 VARCHAR(255),
						amount DECIMAL(18, 2),
						CONSTRAINT PK_{tableName} PRIMARY KEY (entity, wo_id, scenario, year, month, account, intercompany, ud3)
					);
				
					CREATE INDEX idx_entity_wo_id_intercompany ON {tableName}(entity, wo_id, intercompany);
					CREATE INDEX idx_entity_wo_id_intercompany_account ON {tableName}(entity, wo_id, intercompany, account);
					CREATE INDEX idx_entity_wo_id_scenario_year ON {tableName}(entity, wo_id, scenario, year);
				END;
				"
