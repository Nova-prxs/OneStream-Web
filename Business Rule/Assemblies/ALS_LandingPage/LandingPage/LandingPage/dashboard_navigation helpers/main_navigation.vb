				...
				Select Case args.FunctionType
					...
					Case Is = DashboardExtenderFunctionType.LoadDashboard
						If args.FunctionName.XFEqualsIgnoreCase("LoadDashboard") Then
							...
							Dim WorkspacePrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, "ALS_LandingPage.prm_LandingPage_Workspace_Prefix")
							...
							If args.LoadDashboardTaskInfo.Reason = LoadDashboardReasonType.Initialize _
								...
								paramDashboard = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, $"ALS_LandingPage.prm_{WorkspacePrefix}_MainNavigation_Default")
							Else
					...
					Case Is = DashboardExtenderFunctionType.ComponentSelectionChanged
						...
						If args.FunctionName.XFEqualsIgnoreCase("OpenDashboard")
							...
							#Region "Enlazar con Dashboard HR"
							
							brapi.Dashboards.Parameters.SetLiteralParameterValue(si, False, Nothing, "prm_LandingPage_Flag", paramDashboard)
...
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_LandingPage_Scenario_Main") = "Planning"
'					If args.LoadDashboardTaskInfo.CustomSubstVarsFromPriorRun.XFGetValue("prm_LandingPage_Scenario") = "Actual" Then _
'						loadDashboardTaskResult.ModifiedCustomSubstVars("prm_LandingPage_Scenario") = "Budget"
'				Else
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_LandingPage_Scenario_Main") = "Actual"
'					loadDashboardTaskResult.ModifiedCustomSubstVars("prm_LandingPage_Scenario") = "Actual"
'				End If
'			End If
		...
		Private Sub SetDashboardParametersOnClick(
			...
			'Control dashboard parameters
			'EXAMPLE
'			If paramDashboard = "LandingPage_1_1" Then _
'				selectionChangedTaskResult.ModifiedCustomSubstVars("prm_LandingPage_Request_Id") = ""
