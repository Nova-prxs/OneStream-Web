...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class view_business_partners

        'Declare view and table name
		Dim viewName As String = "XFC_MAIN_VIEW_BusinessPartners"
		Dim tableName As String = "XFC_MAIN_MASTER_BusinessPartners"
				...
				Dim upQuery As String = $"
					IF OBJECT_ID(N'{viewName}', N'V') IS NULL
						...
						EXEC('CREATE VIEW {viewName} AS
							SELECT id, name, country, customer_member_name, ic_member_name
							FROM {tableName}
							WHERE type = ''business''
						')
						END;
