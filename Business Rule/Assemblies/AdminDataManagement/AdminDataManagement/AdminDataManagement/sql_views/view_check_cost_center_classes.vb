...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class view_check_cost_center_classes

        'Declare view and table name
		Dim viewName As String = "XFC_MAIN_VIEW_CHECK_CostCenterClasses"
		Dim tableName As String = "XFC_MAIN_MASTER_CostCenterClasses"
				...
				Dim upQuery As String = $"
					IF OBJECT_ID(N'{viewName}', N'V') IS NULL
						...
						EXEC('CREATE VIEW {viewName} AS
							SELECT id, asset_account, depreciation_account
							FROM {tableName}
							WHERE asset_account IS NULL OR asset_account = ''''
								OR depreciation_account IS NULL OR depreciation_account = ''''
						')
						END;
				"
