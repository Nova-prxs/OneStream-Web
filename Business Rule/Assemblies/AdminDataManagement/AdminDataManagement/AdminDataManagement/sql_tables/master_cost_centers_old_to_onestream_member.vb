...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class master_cost_centers_old_to_onestream_member
		
		'Declare table name
		Dim tableName As String = "XFC_MAIN_MASTER_CostCentersOldToOneStreamMember"
            ...
            Try
				...
				BEGIN
					CREATE TABLE {tableName} (
					    id_old VARCHAR(50),
					    onestream_member_name VARCHAR(50)
					)
				END;
				"
