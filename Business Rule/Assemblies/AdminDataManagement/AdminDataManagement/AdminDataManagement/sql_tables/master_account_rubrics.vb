...
Namespace Workspace.__WsNamespacePrefix.__WsAssemblyName
	Public Class master_account_rubrics
		
		'Declare table name
		Dim tableName As String = "XFC_MAIN_MASTER_AccountRubrics"
            ...
            Try
				...
				BEGIN
					CREATE TABLE {tableName} (
					    ...
					    cost_center_class_id VARCHAR(50) NOT NULL,
					    conso_rubric VARCHAR(50),
						CONSTRAINT PK_{tableName} PRIMARY KEY (account_name, cost_center_class_id)
					)
				END;
				"
