			...
			Try
				Select Case args.FunctionType
					...
					Case Is = ExtenderFunctionType.ExecuteDataMgmtBusinessRuleStep
						...
						Dim WSPrefix As String = BRApi.Dashboards.Parameters.GetLiteralParameterValue(si, False, Nothing, "AdminDataManagement.prm_AdminDataManagement_Workspace_Prefix")
