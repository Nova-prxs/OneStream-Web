...
Namespace OneStream.BusinessRule.Extender.PLP_DataMgmt
    Public Class MainClass
        '------------------------------------------------------------------------------------------------------------
        'Reference Code: 		PLP_DataMgmt
        '
        'Description:			People Planning Data Management Business Rule Step Code.
        '
                ...
                Select Case args.FunctionType
                    Case Is = ExtenderFunctionType.ExecuteDataMgmtBusinessRuleStep
                        ...
                        If singleCalc Then
                            ...
                            Dim taskActivityItemCount As Integer = plpHelper.GetTaskActivityItemCount(si, wfClusterPks)
                            plpHelper.CalculateSinglePlan(si, globals, wfClusterPK, taskActivityItemCount, batchSize, useParallelSave, args)
                        Else
                            'Execute a user initiated calculation (Calculate Button)
                            BRApi.ErrorLog.LogMessage(si, "Calculation through user initiated button")
                            plpHelper.CalculateOneOrAllPlans(si, globals, wfClusterPK, args, True)
                        End If
...
#Region "Data Management Helper Functions"
        ...
        Private Sub SetTaskDescription(ByVal si As SessionInfo, ByVal args As ExtenderArgs)
            Try
                ...
                Dim description As String = "People Plan Calc (" & wfDesc & ")"
