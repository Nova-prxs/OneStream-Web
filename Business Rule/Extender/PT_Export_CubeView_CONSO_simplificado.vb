...
Namespace OneStream.BusinessRule.Extender.PT_Export_CubeView_CONSO_simplificado
	Public Class MainClass
		...
		Public Function Main(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As Transformer, ByVal args As ExtenderArgs) As Object 'ByVal api As Transformer
			...
			Try
				...
				Dim cubeViewNameEuros As String = "PT_CONS_Extract_Euros"
				Dim cubeViewNameLocal As String = "PT_CONS_Extract_Local"				
				Dim cubeViewNameEurosLegal As String = "PT_CONS_Extract_Euros_Legal"
				Dim cubeViewNameLocalLegal As String = "PT_CONS_Extract_Local_Legal"
				Dim cubeViewNameTop As String = "PT_CONS_Top"
				...
				Dim buTopMember3 As String = "SECTORES"
...
'								system.IO.file.WriteAllText(filePathLocal,csvstringLocal.tostring)
			...
			Finally
				...
				Dim logFolder As String = Path.Combine(FileShareFolderHelper.GetOutgoingFolderForApp(si, True, FileSystemHelper.GetOSFileShareRootPath(si), si.AppName), "PT_Integration_Logs")
				' Create log folder if it does not exist
				If Not system.IO.Directory.Exists(logFolder) Then
					system.IO.Directory.CreateDirectory(logFolder)
				End If
				' Create log
				Dim logFile As String = Path.Combine(logFolder, "PT_Integration_Log_" & DateTime.Now.ToString("yyyyMMddHHmmss", CultureInfo.InvariantCulture) & ".txt")
