...
Namespace OneStream.BusinessRule.Extender.ExportJournal
	Public Class MainClass
		Public Function Main(ByVal si As SessionInfo, ByVal globals As BRGlobals, ByVal api As Object, ByVal args As ExtenderArgs) As Object
			...
			'Define parameters
'			Dim sprofileName As String = "" '"Historicos"
'			Dim sscenarioName As String = "" '"ACT"
'			Dim stimeMemberFilter As String = "" '"2023M12"
