...
Namespace OneStream.BusinessRule.Connector.CON_Historical_PersonnelHours
			...
			Try
                ...
                Select Case args.ActionType
                    Case Is = ConnectorActionTypes.GetFieldList
						...
						fieldList.Add("Year_Month")
						fieldList.Add("cebe")
						fieldList.Add("employee_category")
						fieldList.Add("night_hs")
						fieldList.Add("supplementary_hs")
						fieldList.Add("productive_hs_total")
						fieldList.Add("regular_hs")
						fieldList.Add("holidays")
						fieldList.Add("overtime")
						fieldList.Add("paid_leave")
						fieldList.Add("unpaid_leave")
						fieldList.Add("IT_long_term_leave")
						fieldList.Add("training")
						fieldList.Add("absances_sanctions")
						fieldList.Add("absences	")				
...
'						-------------------------------------------------------------------------------------------------------------------------
						...
						Dim selectQuery As String = $" SELECT Year_Month
															, cebe
															, employee_category
															, night_hs
															, supplementary_hs
											            ...
											            FROM XFC_PersonnelCost PC
														WHERE CONVERT(VARCHAR, Year_Month) LIKE '{wfYear.toString()}%'
