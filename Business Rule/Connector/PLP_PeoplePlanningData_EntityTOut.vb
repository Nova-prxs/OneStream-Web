...
Namespace OneStream.BusinessRule.Connector.PLP_PeoplePlanningData_EntityTOut
    Public Class MainClass
        ...
        '3) This Connector should be assigned to the Standard People Plan import Workflow (The Workflow that initiates the transfer)
        '
        '--------------------------------------------------------------------------------------------------------------------
